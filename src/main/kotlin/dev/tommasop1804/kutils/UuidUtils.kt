...
fun Uuid.validateVersion(version: UuidVersion, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException("Uuid is not an uuid of version ${version.number}.", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException("Value is not positive.", cause?.invoke(this)))
    return this
}
/**
...
fun Uuid.validateVersion(version: UuidVersion, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null, lazyMessage: Transformer<Uuid, Any>): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)))
    return this
}
/**
...
fun Uuid.validateVersion(version: UuidVersion, property: KProperty<*>?, variableName: String? = null, message: String? = null, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException(property, variableName, message ?: "is not an uuid of version ${version.number}", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variableName, message ?: "is not positive", cause?.invoke(this)))
    return this
}
/**
...
fun Uuid.validateVersion(version: UuidVersion, property: KProperty<*>?, variable: KProperty<*>?, message: String? = null, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException(property, variable, message ?: "is not an uuid of version ${version.number}", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variable, message ?: "is not positive", cause?.invoke(this)))
    return this
}
/**
...
fun Uuid.validateVersion(version: UuidVersion, callable: KFunction<*>?, parameterName: String? = null, message: String? = null, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException(callable, parameterName, message ?: "is not an uuid of version ${version.number}", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameterName, message ?: "is not positive", cause?.invoke(this)))
    return this
}
/**
...
fun Uuid.validateVersion(version: UuidVersion, callable: KFunction<*>?, parameter: KParameter?, message: String? = null, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException(callable, parameter, message ?: "is not an uuid of version ${version.number}", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameter, message ?: "is not positive", cause?.invoke(this)))
    return this
}
/**
...
fun Uuid.validateVersion(version: UuidVersion, callableName: String?, parameterName: String? = null, message: String? = null, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameterName, message ?: "is not an uuid of version ${version.number}", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameterName, message ?: "is not positive", cause?.invoke(this)))
    return this
}
/**
...
fun Uuid.validateVersion(version: UuidVersion, callableName: String?, parameter: KParameter?, message: String? = null, causeOf: Transformer<Uuid, Throwable>? = null, cause: Transformer<Uuid, Throwable>? = null): Uuid {
    if (this.version != version) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameter, message ?: "is not an uuid of version ${version.number}", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameter, message ?: "is not positive", cause?.invoke(this)))
    return this
}
