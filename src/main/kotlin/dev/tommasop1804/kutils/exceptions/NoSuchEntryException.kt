 ...
 */
@Suppress("unused")
class NoSuchEntryException : NoSuchElementException {
    /**
    ...
    constructor() : super()
    /**
     * Constructs an `NoSuchEntryException` with a specific message indicating
    ...
    /**
     * Constructs an `NoSuchEntryException` with a detail message indicating that an entry
    ...
    /**
     * Constructs an `NoSuchEntryException` with the specified detail message.
     *
    ...
    /**
     * Constructs an `NoSuchEntryException` with the specified detail message and cause.
     *
    ...
    /**
     * Constructs an `NoSuchEntryException` with the specified cause.
     *
