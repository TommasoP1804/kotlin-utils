...
private fun <T> T.checkEquality(other: T): Boolean where T : Comparable<T>, T : Temporal = when(this) {
...
private fun <T> T.checkIsBefore(other: T): Boolean where T : Comparable<T>, T : Temporal = when(this) {
...
private fun <T> T.checkIsAfter(other: T): Boolean where T : Comparable<T>, T : Temporal = when(this) {
...
fun <T> T.validateBefore(other: T, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(
...
fun <T> T.validateBefore(other: T, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null, lazyMessage: Transformer<T, Any>): T where T : Comparable<T>, T : Temporal {
    if (!checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateBefore(other: T, property: KProperty<*>?, variableName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variableName, message ?: "is not before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variableName, message ?: "is not before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateBefore(other: T, property: KProperty<*>?, variable: KProperty<*>?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variable, message ?: "is not before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variable, message ?: "is not before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateBefore(other: T, callable: KFunction<*>?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(callable, parameterName, message ?: "is not before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameterName, message ?: "is not before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateBefore(other: T, callableName: String?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameterName, message ?: "is not before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameterName, message ?: "is not before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateBefore(other: T, callableName: String?, parameter: KParameter?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameter, message ?: "is not before $other", cause?.invoke(this)) else causeOf(this).initCause(
...
fun <T> T.validateAfter(other: T, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(
...
fun <T> T.validateAfter(other: T, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null, lazyMessage: Transformer<T, Any>): T where T : Comparable<T>, T : Temporal {
    if (!checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateAfter(other: T, property: KProperty<*>?, variableName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variableName, message ?: "is not after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variableName, message ?: "is not after $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateAfter(other: T, property: KProperty<*>?, variable: KProperty<*>?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variable, message ?: "is not after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variable, message ?: "is not after $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateAfter(other: T, callable: KFunction<*>?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(callable, parameterName, message ?: "is not after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameterName, message ?: "is not after $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateAfter(other: T, callableName: String?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameterName, message ?: "is not after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameterName, message ?: "is not after $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateAfter(other: T, callableName: String?, parameter: KParameter?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameter, message ?: "is not after $other", cause?.invoke(this)) else causeOf(this).initCause(
...
fun <T> T.validateNotBefore(other: T, property: KProperty<*>?, variableName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variableName, message ?: "is before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variableName, message ?: "is before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotBefore(other: T, property: KProperty<*>?, variable: KProperty<*>?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variable, message ?: "is before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variable, message ?: "is not before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotBefore(other: T, callable: KFunction<*>?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(callable, parameterName, message ?: "is before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameterName, message ?: "is before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotBefore(other: T, callableName: String?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameterName, message ?: "is before $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameterName, message ?: "is before $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotBefore(other: T, callableName: String?, parameter: KParameter?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsBefore(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameter, message ?: "is before $other", cause?.invoke(this)) else causeOf(this).initCause(
...
fun <T> T.validateNotAfter(other: T, property: KProperty<*>?, variableName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variableName, message ?: "is after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variableName, message ?: "is after $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotAfter(other: T, property: KProperty<*>?, variable: KProperty<*>?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variable, message ?: "is after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variable, message ?: "is not after $other", cause?.invoke(this)))
    return this
}
/**
 * Validates that the current temporal value is not after the specified temporal value.
...
fun <T> T.validateNotAfter(other: T, callable: KFunction<*>?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(callable, parameterName, message ?: "is after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameterName, message ?: "is after $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotAfter(other: T, callableName: String?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameterName, message ?: "is after $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameterName, message ?: "is after $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotAfter(other: T, callableName: String?, parameter: KParameter?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkIsAfter(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameter, message ?: "is after $other", cause?.invoke(this)) else causeOf(this).initCause(
...
fun <T> T.validateEquals(other: T, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(
...
fun <T> T.validateEquals(other: T, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null, lazyMessage: Transformer<T, Any>): T where T : Comparable<T>, T : Temporal {
    if (!checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(lazyMessage(this).toString(), cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateEquals(other: T, property: KProperty<*>?, variableName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variableName, message ?: "is not equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variableName, message ?: "is not equals to $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateEquals(other: T, property: KProperty<*>?, variable: KProperty<*>?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variable, message ?: "is not equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variable, message ?: "is not equals to $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateEquals(other: T, callable: KFunction<*>?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(callable, parameterName, message ?: "is not equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameterName, message ?: "is not equals to $other", cause?.invoke(this)))
    return this
}
/**
 * Validates if the current object is equal to the specified object. If the validation fails,
...
fun <T> T.validateEquals(other: T, callableName: String?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameterName, message ?: "is not equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameterName, message ?: "is not equals to $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateEquals(other: T, callableName: String?, parameter: KParameter?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (!checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameter, message ?: "is not equals to $other", cause?.invoke(this)) else causeOf(this).initCause(
...
fun <T> T.validateNotEquals(other: T, property: KProperty<*>?, variableName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variableName, message ?: "is equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variableName, message ?: "is equals to $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotEquals(other: T, property: KProperty<*>?, variable: KProperty<*>?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(property, variable, message ?: "is equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(property, variable, message ?: "is equals to $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotEquals(other: T, callable: KFunction<*>?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(callable, parameterName, message ?: "is equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callable, parameterName, message ?: "is equals to $other", cause?.invoke(this)))
    return this
}
/**
 * Validates that the current object is not equal to the specified `other` object. If the validation fails,
...
fun <T> T.validateNotEquals(other: T, callableName: String?, parameterName: String? = null, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameterName, message ?: "is equals to $other", cause?.invoke(this)) else causeOf(this).initCause(ValidationFailedException(callableName, parameterName, message ?: "is equals to $other", cause?.invoke(this)))
    return this
}
/**
...
fun <T> T.validateNotEquals(other: T, callableName: String?, parameter: KParameter?, message: String? = null, causeOf: Transformer<T, Throwable>? = null, cause: Transformer<T, Throwable>? = null): T where T : Comparable<T>, T : Temporal {
    if (checkEquality(other)) throw if (causeOf.isNull()) ValidationFailedException(callableName, parameter, message ?: "is equals to $other", cause?.invoke(this)) else causeOf(this).initCause(
