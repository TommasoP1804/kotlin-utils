...
/**
 * Extension property to check if the Short array is empty.
 *
 * @receiver The Short array being checked.
 * @return `true` if the Short array has no elements, otherwise `false`.
 * @since 6.1.0
 */
val ShortArray.isEmpty get() = isEmpty()
/**
 * Extension property for `ShortArray` that checks if the array is not empty.
 *
 * Returns `true` if the `ShortArray` contains one or more elements.
 * Returns `false` if the `ShortArray` is empty.
 * @since 6.1.0
 */
val ShortArray.isNotEmpty get() = isNotEmpty()
/**
 * Extension property to check if a nullable [ShortArray] is either null or empty.
 *
 * @return `true` if the [ShortArray] is null or has no elements, `false` otherwise.
 * @since 6.1.0
 */
...
/**
 * Extension property for nullable ShortArray that checks if the array is not null and not empty.
 *
 * @receiver Nullable ShortArray to be checked.
 ...
 * @since 6.1.0
 */
val ShortArray.containsDuplicates
 ...
 * @since 6.1.0
 */
val ShortArray.isSingleElement get() = size == 1
/**
 ...
 * @since 6.1.0
 */
val ShortArray.isNotSingleElement get() = size != 1

/**
 * Extension property that evaluates whether the ShortArray is sorted in ascending order.
...
/**
 * Extension property for ShortArray that indicates whether the array is not sorted in ascending order.
 *
 * This property returns `true` if the Short array is not sorted in ascending order, and `false` otherwise.
...
/**
 * An extension property for the `ShortArray` class that checks if the array's elements are sorted
...
/**
 * Extension property for `ShortArray` that determines whether
 * the array is not sorted in descending order.
 *
 * @return `true` if the Short array is not sorted in strictly descending order, `false` otherwise.
 * @since 6.1.0
 */
 ...
 * @since 6.1.0
 */
fun ShortArray.orErrorIfEmpty(): Either<Empty, ShortArray> =
    either { if (isEmpty()) raise(Empty) else this }

/**
 * Returns the current ShortArray if it is not null, or an empty ShortArray if it is null.
 *
 * This function provides a safe way to handle nullable ShortArray instances by ensuring 
 * that a non-null ShortArray is always returned.
 *
 * @return The original ShortArray if it is non-null, otherwise an empty ShortArray.
 * @since 6.1.0
 */
fun ShortArray?.orEmpty() = this ?: shortArrayOf()

/**
 * Performs a logical NOT operation on the nullable [ShortArray].
 * This operator checks whether the [ShortArray] is null or empty.
 *
 * @return `true` if the [ShortArray] is null or empty, otherwise `false`.
 * @since 6.1.0
 */
@JvmName("nullableNot")
...
/**
 * Operator function that checks whether the ShortArray is empty.
 *
 * @return true if the ShortArray is empty, false otherwise.
 * @since 6.1.0
 */
...
fun ShortArray?.merge(vararg collections: Collection<Short>) = orEmpty().toList().merge(*collections).toShortArray()
 ...
 * @since 6.1.0
 */
infix fun ShortArray.intersects(other: ShortArray) = (this intersect other.toSet()).isNotEmpty()
 ...
 * @since 6.1.0
 */
infix fun ShortArray.intersperseWith(separator: Short): ShortArray =
 ...
 * @since 6.1.0
 */
fun ShortArray.containsAny(vararg elements: Short) = any { it in elements }
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.containsNone(vararg elements: Short) = none { it in elements }
/**
 ...
 * @since 6.1.0
 */
operator fun ShortArray.contains(predicate: Predicate<Short>) = any { predicate(it) }
 ...
 * @since 6.1.0
 */
fun ShortArray.firstOr(default: Supplier<Short>): Short {
    contract {
...
fun ShortArray.firstOrThrow(lazyException: ThrowableSupplier): Short {
    contract {
 ...
 *         - `Right<Short>` contains the first element of the array.
 *         - `Left<Shortmpty>` represents an error indicating that the array is empty.
 * @throws Throwable If any exception other than `NoSuchElementException` occurs during execution.
 * @since 6.1.0
 */
fun ShortArray.firstOrError() = either {
 ...
 */
@IgnorableReturnValue
fun ShortArray.findFirst(predicate: Predicate<Short>): Short {
    val list = toList()
 ...
 * @since 6.1.0
 */
fun ShortArray.findFirstOr(default: Supplier<Short>, predicate: Predicate<Short>): Short {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun ShortArray.findFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Short>): Short {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun ShortArray.lastOr(default: Supplier<Short>): Short {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun ShortArray.lastOrThrow(lazyException: ThrowableSupplier): Short {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @receiver ShortArray The array from which the last element is to be retrieved.
 * @return An `Either` where:
 *         - `Right<Short>` contains the last element of the array if it exists.
 *         - `Left<Shortmpty>` represents an error raised when the array is empty.
 * @throws RaiseSignal If the underlying `either` or `catching` functions raise a signal during execution.
 * @see either
 * @see catching
 * @since 6.1.0
 */
fun ShortArray.lastOrError() = either {
 ...
 */
@IgnorableReturnValue
fun ShortArray.findLast(predicate: Predicate<Short>): Short {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun ShortArray.findLastOr(default: Supplier<Short>, predicate: Predicate<Short>): Short {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun ShortArray.findLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Short>): Short {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun ShortArray.second() = if (size < 2) throw NoSuchElementException("List size $size doesn't allow to get second element.") else this[1]
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.secondOrNull() = if (size < 2) null else this[1]
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.secondOr(default: Supplier<Short>): Short {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun ShortArray.secondOrThrow(lazyException: ThrowableSupplier): Short {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun ShortArray.findSecond(predicate: Predicate<Short>): Short {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun ShortArray.findSecondOrNull(predicate: Predicate<Short>) = filter(predicate).secondOrNull()
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.findSecondOr(default: Supplier<Short>, predicate: Predicate<Short>) = filter(predicate).secondOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun ShortArray.findSecondOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Short>) = filter(predicate).secondOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.third() = if (size < 3) throw NoSuchElementException("List size $size doesn't allow to get third element.") else this[2]
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.thirdOrNull() = if (size < 3) null else this[2]
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.thirdOr(default: Supplier<Short>): Short {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun ShortArray.thirdOrThrow(lazyException: ThrowableSupplier): Short {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun ShortArray.findThird(predicate: Predicate<Short>): Short {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun ShortArray.findThirdOrNull(predicate: Predicate<Short>) = filter(predicate).thirdOrNull()
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.findThirdOr(default: Supplier<Short>, predicate: Predicate<Short>) = filter(predicate).thirdOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun ShortArray.findThirdOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Short>) = filter(predicate).thirdOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.onlyElement() = toList().run {
 ...
 * @since 6.1.0
 */
fun ShortArray.onlyElementOrNull() = toList().run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.onlyElementOr(default: Supplier<Short>): Short {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
infix fun ShortArray.onlyElementOrThrow(lazyException: ThrowableSupplier): Short {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @return `Either<NotOnlyElementErrors, Short>` where the right value is the single element of the array if present,
 ...
 * @since 6.1.0
 */
infix fun ShortArray.findOnlyElement(predicate: Predicate<Short>) = toList()
 ...
 * @since 6.1.0
 */
infix fun ShortArray.findOnlyElementOrNull(predicate: Predicate<Short>) = filter(predicate).run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
fun ShortArray.findOnlyElementOr(default: Supplier<Short>, predicate: Predicate<Short>): Short {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun ShortArray.findOnlyElementOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Short>): Short {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
infix fun ShortArray.chunkedWhile(predicate: Predicate<Short>): List<List<Short>> = toList().run {
    if (isEmpty()) return@run emptyList()
    val result = mutableListOf<MutableList<Short>>()
    var current = mutableListOf<Short>()
    for (i in indices) {
        current.add(this[i])
        if (predicate(this[i])) {
            result.add(current)
 ...
 * @since 6.1.0
 */
infix fun ShortArray.repeatEach(n: Int): List<Short> {
    val resultList = mutableListOf<Short>()
    forEach {
        { resultList += it } * n
    }
 ...
 * @since 6.1.0
 */
fun ShortArray.mode(): Short? = toTypedArray().groupingBy { it }.eachCount().maxByOrNull { it.value }?.key
 ...
 * @since 6.1.0
 */
fun ShortArray.indexOfOrThrow(element: Short, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun ShortArray.lastIndexOfOrThrow(element: Short, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun ShortArray.indexOfFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Short>) =
 ...
 * @since 6.1.0
 */
fun ShortArray.indexOfLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Short>) =
 ...
 * @since 6.1.0
 */
inline fun ShortArray?.ifNullOrEmpty(defaultValue: Supplier<ShortArray>): ShortArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun ShortArray.ifNotEmpty(action: Consumer<ShortArray>): ShortArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun ShortArray?.ifNotNullOrEmpty(action: Consumer<ShortArray>): ShortArray? {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
 ...
 */
@IgnorableReturnValue
inline fun ShortArray.ifContains(element: Short, action: Consumer<ShortArray>): ShortArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
inline fun ShortArray.ifNotContains(element: Short, action: Consumer<ShortArray>): ShortArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
    if (!contains(element)) action(this)
 ...
 * @since 6.1.0
 */
infix fun ShortArray.step(step: Int) =  filterIndexed { index, c -> index % step == 0 }
 ...
 * @since 6.1.0
 */
operator fun ShortArray.times(n: Int) = (1..n).flatMap { toList() }.toShortArray()
 ...
 * @since 6.1.0
 */
operator fun ShortArray.div(predicate: Predicate<Short>) = partition(predicate)
 ...
 * @since 6.1.0
 */
operator fun ShortArray.rem(chunkSize: Int): MultiList<Short> = toList().chunked(chunkSize)
/**
 ...
 * @since 6.1.0
 */
operator fun ShortArray.rem(predicate: Predicate<Short>): MultiList<Short> = chunkedWhile(predicate)
 ...
 * @since 6.1.0
 */
operator fun ShortArray.dec(): ShortArray = toList().subList(0, lastIndex).toShortArray()
/**
 ...
 * @since 6.1.0
 */
operator fun ShortArray.rangeTo(endIndex: Int) = toList().subList(0, endIndex + 1).toShortArray()
 ...
 * @since 6.1.0
 */
operator fun ShortArray.invoke(circularStartIndex: Int, circularEndIndex: Int, step: Int = 1): ShortArray {
 ...
 * @since 6.1.0
 */
operator fun ShortArray.invoke(circularRange: IntRange, step: Int = 1) =
 ...
 * @since 6.1.0
 */
operator fun ShortArray.invoke(circularProgression: IntProgression): ShortArray {
 ...
 * @since 6.1.0
 */
operator fun ShortArray.invoke(circularIndex: Int): Short {
    if (isEmpty()) throw IndexOutOfBoundsException("List cannot be null.")
 ...
 * @since 6.1.0
 */
inline operator fun ShortArray.invoke(filter: Predicate<Short>): ShortArray {
    val destination = ArrayList<Short>()
    for (element in this) if (filter(element)) destination.add(element)
    return destination.toShortArray()
}
 ...
 * @since 6.1.0
 */
inline operator fun ShortArray.get(find: Predicate<Short>): Short? {
 ...
 * @since 6.1.0
 */
operator fun ShortArray.get(find: Predicate<Short>, lazyException: ThrowableSupplier): Short {
    for (element in this) if (find(element)) return element
    throw lazyException()
}
 ...
 * @since 6.1.0
 */
operator fun ShortArray.minus(filterNot: Predicate<Short>) = filterNot(filterNot)
...
operator fun ShortArray.get(range: IntProgression) = toList().subList(range).toShortArray()
 ...
 * @since 6.1.0
 */
operator fun ShortArray.get(index: Int, lazyException: ThrowableSupplier = { IndexOutOfBoundsException("Index $index not present") }): Short =
 ...
 * @since 6.1.0
 */
operator fun ShortArray.get(percentage: Percentage) = percent(percentage)
 ...
 * @since 6.1.0
 */
infix fun ShortArray.sorted(direction: SortDirection) = when (direction) {
 ...
 * @since 6.1.0
 */
inline fun <R : Comparable<R>> ShortArray.sortedBy(direction: SortDirection, crossinline selector: Transformer<Short, R?>) = when (direction) {
 ...
 * @since 6.1.0
 */
infix fun ShortArray.before(element: Short) = if (contains(element)) get(0..<indexOf(element)) else shortArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.beforeIncluding(element: Short) = if (contains(element)) get(0..indexOf(element)) else shortArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.beforeLast(element: Short) = if (contains(element)) get(0..<lastIndexOf(element)) else shortArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.beforeLastIncluding(element: Short) = if (contains(element)) get(0..lastIndexOf(element)) else shortArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.after(element: Short) = if (contains(element)) get(indexOf(element) + 1..<size) else shortArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.afterIncluding(element: Short) = if (contains(element)) get(indexOf(element)..size) else shortArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.afterLast(element: Short) = if (contains(element)) get(lastIndexOf(element) + 1..<size) else shortArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun ShortArray.afterLastIncluding(element: Short) = if (contains(element)) get(lastIndexOf(element)..size) else shortArrayOf()
...
infix fun ShortArray.percent(p: Percentage): Short {
 ...
 * @since 6.1.0
 */
inline fun <K, V> ShortArray.associate(key: Transformer<Short, K>, value: Transformer<Short, V>) =
...
inline fun <K, V, M : MutableMap<in K, in V>> ShortArray.associateTo(
    destination: M,
    key: Transformer<Short, K>,
    value: Transformer<Short, V>
 ...
 * 
 * @param element A transformer function that takes an element of type [Short] and returns a result of type [R].
 * @since 6.1.0
 */
inline infix fun <R> ShortArray.filterNotNull(element: Transformer<Short, R>) =
 ...
 * @since 6.1.0
 */
inline infix fun <R> ShortArray.filterNull(element: Transformer<Short, R>) =
    filter { element(it) == null }
 ...
 */
@IgnorableReturnValue
inline fun ShortArray.cForEach(block: ReceiverBiConsumer<LoopContext, Short>) = apply {
    with(LoopContext()) {
 ...
 */
@IgnorableReturnValue
inline fun ShortArray.cForEachIndexed(block: ReceiverTriConsumer<LoopContext, Int, Short>) = apply {
    with(LoopContext()) {
 ...
 * @param action a function that accepts a loop context and an element of type `Short`. 
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> ShortArray.rForEach(action: ReceiverBiConsumer<LoopContext, Short>): R? {
    with(LoopContext()) {
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> ShortArray.rForEachIndexed(action: ReceiverTriConsumer<LoopContext, Int, Short>): R? {
    with(LoopContext()) {
        for ([index, element] in withIndex()) {
            try {
