...
@file:JvmName("ArrayDoubleUtilsKt")
@file:Since("6.1.0")
...
/**
 * Extension property to check if the Double array is empty.
 *
 * @receiver The Double array being checked.
 * @return `true` if the Double array has no elements, otherwise `false`.
 * @since 6.1.0
 */
 ...
 *
 * Returns `true` if the `DoubleArray` contains one or more elements.
 * Returns `false` if the `DoubleArray` is empty.
 * @since 6.1.0
 */
val DoubleArray.isNotEmpty get() = isNotEmpty()
/**
 * Extension property to check if a nullable [DoubleArray] is either null or empty.
 *
 * @return `true` if the [DoubleArray] is null or has no elements, `false` otherwise.
 * @since 6.1.0
 */
...
/**
 * Extension property for nullable DoubleArray that checks if the array is not null and not empty.
 *
 * @receiver Nullable DoubleArray to be checked.
 ...
 * @since 6.1.0
 */
val DoubleArray.containsDuplicates
 ...
 * @since 6.1.0
 */
val DoubleArray.isSingleElement get() = size == 1
/**
 ...
 * @since 6.1.0
 */
val DoubleArray.isNotSingleElement get() = size != 1

/**
 * Extension property that evaluates whether the DoubleArray is sorted in ascending order.
...
/**
 * Extension property for DoubleArray that indicates whether the array is not sorted in ascending order.
 *
 * This property returns `true` if the Double array is not sorted in ascending order, and `false` otherwise.
...
/**
 * An extension property for the `DoubleArray` class that checks if the array's elements are sorted
...
/**
 * Extension property for `DoubleArray` that determines whether
 * the array is not sorted in descending order.
 *
 * @return `true` if the Double array is not sorted in strictly descending order, `false` otherwise.
 * @since 6.1.0
 */
 ...
 * @since 6.1.0
 */
fun DoubleArray.orErrorIfEmpty(): Either<Empty, DoubleArray> =
    either { if (isEmpty()) raise(Empty) else this }

/**
 * Returns the current DoubleArray if it is not null, or an empty DoubleArray if it is null.
 *
 * This function provides a safe way to handle nullable DoubleArray instances by ensuring 
 * that a non-null DoubleArray is always returned.
 *
 * @return The original DoubleArray if it is non-null, otherwise an empty DoubleArray.
 * @since 6.1.0
 */
fun DoubleArray?.orEmpty() = this ?: doubleArrayOf()

/**
 * Performs a logical NOT operation on the nullable [DoubleArray].
 * This operator checks whether the [DoubleArray] is null or empty.
 *
 * @return `true` if the [DoubleArray] is null or empty, otherwise `false`.
 * @since 6.1.0
 */
@JvmName("nullableNot")
...
/**
 * Operator function that checks whether the DoubleArray is empty.
 *
 * @return true if the DoubleArray is empty, false otherwise.
 * @since 6.1.0
 */
...
fun DoubleArray?.merge(vararg collections: Collection<Double>) = orEmpty().toList().merge(*collections).toDoubleArray()
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.intersects(other: DoubleArray) = (this intersect other.toSet()).isNotEmpty()
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.intersperseWith(separator: Double): DoubleArray =
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.contains(predicate: Predicate<Double>) = any { predicate(it) }
 ...
 * @since 6.1.0
 */
fun DoubleArray.firstOr(default: Supplier<Double>): Double {
    contract {
...
fun DoubleArray.firstOrThrow(lazyException: ThrowableSupplier): Double {
    contract {
 ...
 *         - `Right<Double>` contains the first element of the array.
 *         - `Left<Doublempty>` represents an error indicating that the array is empty.
 * @throws Throwable If any exception other than `NoSuchElementException` occurs during execution.
 * @since 6.1.0
 */
fun DoubleArray.firstOrError() = either {
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findFirst(predicate: Predicate<Double>): Double {
    val list = toList()
 ...
 * @since 6.1.0
 */
fun DoubleArray.findFirstOr(default: Supplier<Double>, predicate: Predicate<Double>): Double {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Double>): Double {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun DoubleArray.findFirstOrError(predicate: Predicate<Double>): Either<NotFirstResultError, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.lastOr(default: Supplier<Double>): Double {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun DoubleArray.lastOrThrow(lazyException: ThrowableSupplier): Double {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @receiver DoubleArray The array from which the last element is to be retrieved.
 * @return An `Either` where:
 *         - `Right<Double>` contains the last element of the array if it exists.
 *         - `Left<Doublempty>` represents an error raised when the array is empty.
 * @throws RaiseSignal If the underlying `either` or `catching` functions raise a signal during execution.
 * @see either
 * @see catching
 * @since 6.1.0
 */
fun DoubleArray.lastOrError() = either {
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findLast(predicate: Predicate<Double>): Double {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun DoubleArray.findLastOr(default: Supplier<Double>, predicate: Predicate<Double>): Double {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Double>): Double {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun DoubleArray.findLastOrError(predicate: Predicate<Double>): Either<NotLastResultsError, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.second() = if (size < 2) throw NoSuchElementException("List size $size doesn't allow to get second element.") else this[1]
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.secondOrNull() = if (size < 2) null else this[1]
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.secondOr(default: Supplier<Double>): Double {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun DoubleArray.secondOrThrow(lazyException: ThrowableSupplier): Double {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun DoubleArray.secondOrError(): Either<NotInnerElementError, Double> = either {
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findSecond(predicate: Predicate<Double>): Double {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun DoubleArray.findSecondOrNull(predicate: Predicate<Double>) = filter(predicate).secondOrNull()
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.findSecondOr(default: Supplier<Double>, predicate: Predicate<Double>) = filter(predicate).secondOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findSecondOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Double>) = filter(predicate).secondOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.findSecondOrError(predicate: Predicate<Double>): Either<NotInnerResultError, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.third() = if (size < 3) throw NoSuchElementException("List size $size doesn't allow to get third element.") else this[2]
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.thirdOrNull() = if (size < 3) null else this[2]
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.thirdOr(default: Supplier<Double>): Double {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun DoubleArray.thirdOrThrow(lazyException: ThrowableSupplier): Double {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun DoubleArray.thirdOrError(): Either<NotInnerElementError, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.findThird(predicate: Predicate<Double>): Double {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun DoubleArray.findThirdOrNull(predicate: Predicate<Double>) = filter(predicate).thirdOrNull()
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.findThirdOr(default: Supplier<Double>, predicate: Predicate<Double>) = filter(predicate).thirdOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findThirdOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Double>) = filter(predicate).thirdOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.findThirdOrError(predicate: Predicate<Double>): Either<NotInnerResultError, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.onlyElement() = toList().run {
 ...
 * @since 6.1.0
 */
fun DoubleArray.onlyElementOrNull() = toList().run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.onlyElementOr(default: Supplier<Double>): Double {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
infix fun DoubleArray.onlyElementOrThrow(lazyException: ThrowableSupplier): Double {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @return `Either<NotOnlyElementErrors, Double>` where the right value is the single element of the array if present,
 ...
 * @since 6.1.0
 */
fun DoubleArray.onlyElementOrError(): Either<NotOnlyElementError, Double> = either {
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.findOnlyElement(predicate: Predicate<Double>) = toList()
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.findOnlyElementOrNull(predicate: Predicate<Double>) = filter(predicate).run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
fun DoubleArray.findOnlyElementOr(default: Supplier<Double>, predicate: Predicate<Double>): Double {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun DoubleArray.findOnlyElementOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Double>): Double {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun DoubleArray.findOnlyElementOrError(predicate: Predicate<Double>): Either<NotOnlyResultError, Double> = either {
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.chunkedWhile(predicate: Predicate<Double>): List<List<Double>> = toList().run {
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.repeatEach(n: Int): List<Double> {
 ...
 * @since 6.1.0
 */
fun DoubleArray.mode(): Double? = toTypedArray().groupingBy { it }.eachCount().maxByOrNull { it.value }?.key
 ...
 * @since 6.1.0
 */
fun DoubleArray.indexOfFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Double>) =
 ...
 * @since 6.1.0
 */
fun DoubleArray.indexOfLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Double>) =
 ...
 * @since 6.1.0
 */
fun DoubleArray.indexOfFirstOrError(predicate: Predicate<Double>) = either {
 ...
 *
 * @param predicate A lambda function that takes an element of type [Double] and returns `true`
 ...
 * @since 6.1.0
 */
fun DoubleArray.indexOfLastOrError(predicate: Predicate<Double>) = either {
 ...
 * @since 6.1.0
 */
inline fun DoubleArray?.ifNullOrEmpty(defaultValue: Supplier<DoubleArray>): DoubleArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun DoubleArray.ifNotEmpty(action: Consumer<DoubleArray>): DoubleArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun DoubleArray?.ifNotNullOrEmpty(action: Consumer<DoubleArray>): DoubleArray? {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.step(step: Int) =  filterIndexed { index, c -> index % step == 0 }
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.times(n: Int) = (1..n).flatMap { toList() }.toDoubleArray()
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.div(predicate: Predicate<Double>) = partition(predicate)
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.rem(chunkSize: Int): MultiList<Double> = toList().chunked(chunkSize)
/**
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.rem(predicate: Predicate<Double>): MultiList<Double> = chunkedWhile(predicate)
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.dec(): DoubleArray = toList().subList(0, lastIndex).toDoubleArray()
/**
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.rangeTo(endIndex: Int) = toList().subList(0, endIndex + 1).toDoubleArray()
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.invoke(circularStartIndex: Int, circularEndIndex: Int, step: Int = 1): DoubleArray {
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.invoke(circularRange: IntRange, step: Int = 1) =
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.invoke(circularProgression: IntProgression): DoubleArray {
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.invoke(circularIndex: Int): Double {
    if (isEmpty()) throw IndexOutOfBoundsException("List cannot be null.")
 ...
 * @since 6.1.0
 */
inline operator fun DoubleArray.invoke(filter: Predicate<Double>): DoubleArray {
    val destination = ArrayList<Double>()
    for (element in this) if (filter(element)) destination.add(element)
    return destination.toDoubleArray()
}
 ...
 * @since 6.1.0
 */
inline operator fun DoubleArray.get(find: Predicate<Double>): Double? {
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.get(find: Predicate<Double>, lazyException: ThrowableSupplier): Double {
    for (element in this) if (find(element)) return element
    throw lazyException()
}
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.minus(filterNot: Predicate<Double>) = filterNot(filterNot)
...
operator fun DoubleArray.get(range: IntProgression) = toList().subList(range).toDoubleArray()
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.get(index: Int, lazyException: ThrowableSupplier = { IndexOutOfBoundsException("Index $index not present") }): Double =
 ...
 * @since 6.1.0
 */
operator fun DoubleArray.get(percentage: Percentage) = percent(percentage)
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.sorted(direction: SortDirection) = when (direction) {
 ...
 * @since 6.1.0
 */
inline fun <R : Comparable<R>> DoubleArray.sortedBy(direction: SortDirection, crossinline selector: Transformer<Double, R?>) = when (direction) {
...
infix fun DoubleArray.percent(p: Percentage): Double {
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.percentOrError(p: Percentage): Either<IndexOutOfBoundsError, Double> = either {
 ...
 * @since 6.1.0
 */
inline fun <K, V> DoubleArray.associate(key: Transformer<Double, K>, value: Transformer<Double, V>) =
...
inline fun <K, V, M : MutableMap<in K, in V>> DoubleArray.associateTo(
    destination: M,
    key: Transformer<Double, K>,
    value: Transformer<Double, V>
 ...
 * 
 * @param element A transformer function that takes an element of type [Double] and returns a result of type [R].
 * @since 6.1.0
 */
inline infix fun <R> DoubleArray.filterNotNull(element: Transformer<Double, R>) =
 ...
 * @since 6.1.0
 */
inline infix fun <R> DoubleArray.filterNull(element: Transformer<Double, R>) =
    filter { element(it) == null }
 ...
 */
@IgnorableReturnValue
inline fun DoubleArray.cForEach(block: ReceiverBiConsumer<LoopContext, Double>) = apply {
    with(LoopContext()) {
 ...
 */
@IgnorableReturnValue
inline fun DoubleArray.cForEachIndexed(block: ReceiverTriConsumer<LoopContext, Int, Double>) = apply {
    with(LoopContext()) {
 ...
 * @param action a function that accepts a loop context and an element of type `Double`. 
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> DoubleArray.rForEach(action: ReceiverBiConsumer<LoopContext, Double>): R? {
    with(LoopContext()) {
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> DoubleArray.rForEachIndexed(action: ReceiverTriConsumer<LoopContext, Int, Double>): R? {
    with(LoopContext()) {
        for ([index, element] in withIndex()) {
            try {
