 ...
 * @since 6.1.0
 */
fun DoubleArray.findFirstOrError(predicate: Predicate<Double>): Either<NotFirstResultErrors, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.findLastOrError(predicate: Predicate<Double>): Either<NotLastResultsErrors, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.secondOrError(): Either<NotInnerElementErrors, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.findSecondOrError(predicate: Predicate<Double>): Either<NotInnerResultErrors, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.thirdOrError(): Either<NotInnerElementErrors, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.findThirdOrError(predicate: Predicate<Double>): Either<NotInnerResultErrors, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.onlyElementOrError(): Either<NotOnlyElementErrors, Double> = either {
 ...
 * @since 6.1.0
 */
fun DoubleArray.findOnlyElementOrError(predicate: Predicate<Double>): Either<NotOnlyResultErrors, Double> = either {
 ...
 * @since 6.1.0
 */
infix fun DoubleArray.percentOrError(p: Percentage): Either<IndexOutOfBoundsErrors, Double> = either {
