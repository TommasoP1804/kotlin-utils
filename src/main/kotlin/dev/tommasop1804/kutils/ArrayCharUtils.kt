...
/**
 * Extension property to check if the Char array is empty.
 *
 * @receiver The Char array being checked.
 * @return `true` if the Char array has no elements, otherwise `false`.
 * @since 6.1.0
 */
val CharArray.isEmpty get() = isEmpty()
/**
 * Extension property for `CharArray` that checks if the array is not empty.
 *
 * Returns `true` if the `CharArray` contains one or more elements.
 * Returns `false` if the `CharArray` is empty.
 * @since 6.1.0
 */
val CharArray.isNotEmpty get() = isNotEmpty()
/**
 * Extension property to check if a nullable [CharArray] is either null or empty.
 *
 * @return `true` if the [CharArray] is null or has no elements, `false` otherwise.
 * @since 6.1.0
 */
...
/**
 * Extension property for nullable CharArray that checks if the array is not null and not empty.
 *
 * @receiver Nullable CharArray to be checked.
 ...
 * @since 6.1.0
 */
val CharArray.containsDuplicates
 ...
 * @since 6.1.0
 */
val CharArray.isSingleElement get() = size == 1
/**
 ...
 * @since 6.1.0
 */
val CharArray.isNotSingleElement get() = size != 1

/**
 * Extension property that evaluates whether the CharArray is sorted in ascending order.
...
/**
 * Extension property for CharArray that indicates whether the array is not sorted in ascending order.
 *
 * This property returns `true` if the Char array is not sorted in ascending order, and `false` otherwise.
...
/**
 * An extension property for the `CharArray` class that checks if the array's elements are sorted
...
/**
 * Extension property for `CharArray` that determines whether
 * the array is not sorted in descending order.
 *
 * @return `true` if the Char array is not sorted in strictly descending order, `false` otherwise.
 * @since 6.1.0
 */
 ...
 *
 * This function provides a safe way to handle nullable CharArray instances by ensuring 
 * that a non-null CharArray is always returned.
 *
 * @return The original CharArray if it is non-null, otherwise an empty CharArray.
 * @since 6.1.0
 */
fun CharArray?.orEmpty() = this ?: charArrayOf()

/**
 * Performs a logical NOT operation on the nullable [CharArray].
 * This operator checks whether the [CharArray] is null or empty.
 *
 * @return `true` if the [CharArray] is null or empty, otherwise `false`.
 * @since 6.1.0
 */
@JvmName("nullableNot")
...
/**
 * Operator function that checks whether the CharArray is empty.
 *
 * @return true if the CharArray is empty, false otherwise.
 * @since 6.1.0
 */
...
fun CharArray?.merge(vararg collections: Collection<Char>) = orEmpty().toList().merge(*collections).toCharArray()
 ...
 * @since 6.1.0
 */
infix fun CharArray.intersects(other: CharArray) = (this intersect other.toSet()).isNotEmpty()
 ...
 * @since 6.1.0
 */
infix fun CharArray.intersperseWith(separator: Char): CharArray =
 ...
 * @since 6.1.0
 */
fun CharArray.containsAny(vararg elements: Char) = any { it in elements }
/**
 ...
 * @since 6.1.0
 */
fun CharArray.containsNone(vararg elements: Char) = none { it in elements }
/**
 ...
 * @since 6.1.0
 */
operator fun CharArray.contains(predicate: Predicate<Char>) = any { predicate(it) }
 ...
 * @since 6.1.0
 */
fun CharArray.firstOr(default: Supplier<Char>): Char {
    contract {
...
fun CharArray.firstOrThrow(lazyException: ThrowableSupplier): Char {
    contract {
 ...
 *         - `Right<Char>` contains the first element of the array.
 *         - `Left<Charmpty>` represents an error indicating that the array is empty.
 * @throws Throwable If any exception other than `NoSuchElementException` occurs during execution.
 * @since 6.1.0
 */
fun CharArray.firstOrError() = either {
 ...
 */
@IgnorableReturnValue
fun CharArray.findFirst(predicate: Predicate<Char>): Char {
    val list = toList()
 ...
 * @since 6.1.0
 */
fun CharArray.findFirstOr(default: Supplier<Char>, predicate: Predicate<Char>): Char {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun CharArray.findFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Char>): Char {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun CharArray.findFirstOrError(predicate: Predicate<Char>): Either<NotFirstResultError, Char> = either {
 ...
 * @since 6.1.0
 */
fun CharArray.lastOr(default: Supplier<Char>): Char {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun CharArray.lastOrThrow(lazyException: ThrowableSupplier): Char {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @receiver CharArray The array from which the last element is to be retrieved.
 * @return An `Either` where:
 *         - `Right<Char>` contains the last element of the array if it exists.
 *         - `Left<Charmpty>` represents an error raised when the array is empty.
 * @throws RaiseSignal If the underlying `either` or `catching` functions raise a signal during execution.
 * @see either
 * @see catching
 * @since 6.1.0
 */
fun CharArray.lastOrError() = either {
 ...
 */
@IgnorableReturnValue
fun CharArray.findLast(predicate: Predicate<Char>): Char {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun CharArray.findLastOr(default: Supplier<Char>, predicate: Predicate<Char>): Char {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun CharArray.findLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Char>): Char {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun CharArray.findLastOrError(predicate: Predicate<Char>): Either<NotLastResultsError, Char> = either {
 ...
 * @since 6.1.0
 */
fun CharArray.second() = if (size < 2) throw NoSuchElementException("List size $size doesn't allow to get second element.") else this[1]
/**
 ...
 * @since 6.1.0
 */
fun CharArray.secondOrNull() = if (size < 2) null else this[1]
/**
 ...
 * @since 6.1.0
 */
fun CharArray.secondOr(default: Supplier<Char>): Char {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun CharArray.secondOrThrow(lazyException: ThrowableSupplier): Char {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun CharArray.secondOrError(): Either<NotInnerElementError, Char> = either {
 ...
 */
@IgnorableReturnValue
fun CharArray.findSecond(predicate: Predicate<Char>): Char {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun CharArray.findSecondOrNull(predicate: Predicate<Char>) = filter(predicate).secondOrNull()
/**
 ...
 * @since 6.1.0
 */
fun CharArray.findSecondOr(default: Supplier<Char>, predicate: Predicate<Char>) = filter(predicate).secondOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun CharArray.findSecondOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Char>) = filter(predicate).secondOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun CharArray.findSecondOrError(predicate: Predicate<Char>): Either<NotInnerResultError, Char> = either {
 ...
 * @since 6.1.0
 */
fun CharArray.third() = if (size < 3) throw NoSuchElementException("List size $size doesn't allow to get third element.") else this[2]
/**
 ...
 * @since 6.1.0
 */
fun CharArray.thirdOrNull() = if (size < 3) null else this[2]
/**
 ...
 * @since 6.1.0
 */
fun CharArray.thirdOr(default: Supplier<Char>): Char {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun CharArray.thirdOrThrow(lazyException: ThrowableSupplier): Char {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun CharArray.thirdOrError(): Either<NotInnerElementError, Char> = either {
 ...
 * @since 6.1.0
 */
fun CharArray.findThird(predicate: Predicate<Char>): Char {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun CharArray.findThirdOrNull(predicate: Predicate<Char>) = filter(predicate).thirdOrNull()
/**
 ...
 * @since 6.1.0
 */
fun CharArray.findThirdOr(default: Supplier<Char>, predicate: Predicate<Char>) = filter(predicate).thirdOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun CharArray.findThirdOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Char>) = filter(predicate).thirdOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun CharArray.findThirdOrError(predicate: Predicate<Char>): Either<NotInnerResultError, Char> = either {
 ...
 * @since 6.1.0
 */
fun CharArray.onlyElement() = toList().run {
 ...
 * @since 6.1.0
 */
fun CharArray.onlyElementOrNull() = toList().run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.onlyElementOr(default: Supplier<Char>): Char {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
infix fun CharArray.onlyElementOrThrow(lazyException: ThrowableSupplier): Char {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @return `Either<NotOnlyElementErrors, Char>` where the right value is the single element of the array if present,
 ...
 * @since 6.1.0
 */
fun CharArray.onlyElementOrError(): Either<NotOnlyElementError, Char> = either {
 ...
 * @since 6.1.0
 */
infix fun CharArray.findOnlyElement(predicate: Predicate<Char>) = toList()
 ...
 * @since 6.1.0
 */
infix fun CharArray.findOnlyElementOrNull(predicate: Predicate<Char>) = filter(predicate).run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
fun CharArray.findOnlyElementOr(default: Supplier<Char>, predicate: Predicate<Char>): Char {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun CharArray.findOnlyElementOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Char>): Char {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun CharArray.findOnlyElementOrError(predicate: Predicate<Char>): Either<NotOnlyResultError, Char> = either {
 ...
 * @since 6.1.0
 */
infix fun CharArray.chunkedWhile(predicate: Predicate<Char>): List<List<Char>> = toList().run {
 ...
 * @since 6.1.0
 */
infix fun CharArray.repeatEach(n: Int): List<Char> {
 ...
 * @since 6.1.0
 */
fun CharArray.mode(): Char? = toTypedArray().groupingBy { it }.eachCount().maxByOrNull { it.value }?.key
 ...
 * @since 6.1.0
 */
fun CharArray.indexOfOrThrow(element: Char, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun CharArray.lastIndexOfOrThrow(element: Char, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun CharArray.indexOfFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Char>) =
 ...
 * @since 6.1.0
 */
fun CharArray.indexOfLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Char>) =
 ...
 * @since 6.1.0
 */
fun CharArray.indexOfOrError(element: Char) = either {
 ...
 * @since 6.1.0
 */
fun CharArray.lastIndexOfOrError(element: Char) = either {
 ...
 * @since 6.1.0
 */
fun CharArray.indexOfFirstOrError(predicate: Predicate<Char>) = either {
 ...
 *
 * @param predicate A lambda function that takes an element of type [Char] and returns `true`
 ...
 * @since 6.1.0
 */
fun CharArray.indexOfLastOrError(predicate: Predicate<Char>) = either {
 ...
 * @since 6.1.0
 */
inline fun CharArray?.ifNullOrEmpty(defaultValue: Supplier<CharArray>): CharArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun CharArray.ifNotEmpty(action: Consumer<CharArray>): CharArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun CharArray?.ifNotNullOrEmpty(action: Consumer<CharArray>): CharArray? {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
 ...
 */
@IgnorableReturnValue
inline fun CharArray.ifContains(element: Char, action: Consumer<CharArray>): CharArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
inline fun CharArray.ifNotContains(element: Char, action: Consumer<CharArray>): CharArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
    if (!contains(element)) action(this)
 ...
 * @since 6.1.0
 */
infix fun CharArray.step(step: Int) =  filterIndexed { index, c -> index % step == 0 }
 ...
 * @since 6.1.0
 */
operator fun CharArray.times(n: Int) = (1..n).flatMap { toList() }.toCharArray()
 ...
 * @since 6.1.0
 */
operator fun CharArray.div(predicate: Predicate<Char>) = partition(predicate)
 ...
 * @since 6.1.0
 */
operator fun CharArray.rem(chunkSize: Int): MultiList<Char> = toList().chunked(chunkSize)
/**
 ...
 * @since 6.1.0
 */
operator fun CharArray.rem(predicate: Predicate<Char>): MultiList<Char> = chunkedWhile(predicate)
 ...
 * @since 6.1.0
 */
operator fun CharArray.dec(): CharArray = toList().subList(0, lastIndex).toCharArray()
/**
 ...
 * @since 6.1.0
 */
operator fun CharArray.rangeTo(endIndex: Int) = toList().subList(0, endIndex + 1).toCharArray()
 ...
 * @since 6.1.0
 */
operator fun CharArray.invoke(circularStartIndex: Int, circularEndIndex: Int, step: Int = 1): CharArray {
 ...
 * @since 6.1.0
 */
operator fun CharArray.invoke(circularRange: IntRange, step: Int = 1) =
 ...
 * @since 6.1.0
 */
operator fun CharArray.invoke(circularProgression: IntProgression): CharArray {
 ...
 * @since 6.1.0
 */
operator fun CharArray.invoke(circularIndex: Int): Char {
    if (isEmpty()) throw IndexOutOfBoundsException("List cannot be null.")
 ...
 * @since 6.1.0
 */
inline operator fun CharArray.invoke(filter: Predicate<Char>): CharArray {
    val destination = ArrayList<Char>()
    for (element in this) if (filter(element)) destination.add(element)
    return destination.toCharArray()
}
 ...
 * @since 6.1.0
 */
inline operator fun CharArray.get(find: Predicate<Char>): Char? {
 ...
 * @since 6.1.0
 */
operator fun CharArray.get(find: Predicate<Char>, lazyException: ThrowableSupplier): Char {
    for (element in this) if (find(element)) return element
    throw lazyException()
}
 ...
 * @since 6.1.0
 */
operator fun CharArray.minus(filterNot: Predicate<Char>) = filterNot(filterNot)
...
operator fun CharArray.get(range: IntProgression) = toList().subList(range).toCharArray()
 ...
 * @since 6.1.0
 */
operator fun CharArray.get(index: Int, lazyException: ThrowableSupplier = { IndexOutOfBoundsException("Index $index not present") }): Char =
 ...
 * @since 6.1.0
 */
operator fun CharArray.get(percentage: Percentage) = percent(percentage)
 ...
 * @since 6.1.0
 */
infix fun CharArray.sorted(direction: SortDirection) = when (direction) {
 ...
 * @since 6.1.0
 */
inline fun <R : Comparable<R>> CharArray.sortedBy(direction: SortDirection, crossinline selector: Transformer<Char, R?>) = when (direction) {
 ...
 * @since 6.1.0
 */
infix fun CharArray.before(element: Char) = if (contains(element)) get(0..<indexOf(element)) else charArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.beforeIncluding(element: Char) = if (contains(element)) get(0..indexOf(element)) else charArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.beforeLast(element: Char) = if (contains(element)) get(0..<lastIndexOf(element)) else charArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.beforeLastIncluding(element: Char) = if (contains(element)) get(0..lastIndexOf(element)) else charArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.after(element: Char) = if (contains(element)) get(indexOf(element) + 1..<size) else charArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.afterIncluding(element: Char) = if (contains(element)) get(indexOf(element)..size) else charArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.afterLast(element: Char) = if (contains(element)) get(lastIndexOf(element) + 1..<size) else charArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun CharArray.afterLastIncluding(element: Char) = if (contains(element)) get(lastIndexOf(element)..size) else charArrayOf()
...
infix fun CharArray.percent(p: Percentage): Char {
 ...
 * @since 6.1.0
 */
infix fun CharArray.percentOrError(p: Percentage): Either<IndexOutOfBoundsError, Char> = either {
 ...
 * @since 6.1.0
 */
inline fun <K, V> CharArray.associate(key: Transformer<Char, K>, value: Transformer<Char, V>) =
 ...
 * 
 * @param element A transformer function that takes an element of type [Char] and returns a result of type [R].
 * @since 6.1.0
 */
inline infix fun <R> CharArray.filterNotNull(element: Transformer<Char, R>) =
 ...
 * @since 6.1.0
 */
inline infix fun <R> CharArray.filterNull(element: Transformer<Char, R>) =
    filter { element(it) == null }
 ...
 */
@IgnorableReturnValue
inline fun CharArray.cForEach(block: ReceiverBiConsumer<LoopContext, Char>) = apply {
    with(LoopContext()) {
 ...
 */
@IgnorableReturnValue
inline fun CharArray.cForEachIndexed(block: ReceiverTriConsumer<LoopContext, Int, Char>) = apply {
    with(LoopContext()) {
 ...
 * @param action a function that accepts a loop context and an element of type `Char`. 
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> CharArray.rForEach(action: ReceiverBiConsumer<LoopContext, Char>): R? {
    with(LoopContext()) {
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> CharArray.rForEachIndexed(action: ReceiverTriConsumer<LoopContext, Int, Char>): R? {
    with(LoopContext()) {
        for ([index, element] in withIndex()) {
            try {
