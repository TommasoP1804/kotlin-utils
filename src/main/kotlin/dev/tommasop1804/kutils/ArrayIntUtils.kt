...
/**
 * Extension property to check if the Int array is empty.
 *
 * @receiver The Int array being checked.
 * @return `true` if the Int array has no elements, otherwise `false`.
 * @since 6.1.0
 */
val IntArray.isEmpty get() = isEmpty()
/**
 * Extension property for `IntArray` that checks if the array is not empty.
 *
 * Returns `true` if the `IntArray` contains one or more elements.
 * Returns `false` if the `IntArray` is empty.
 * @since 6.1.0
 */
val IntArray.isNotEmpty get() = isNotEmpty()
/**
 * Extension property to check if a nullable [IntArray] is either null or empty.
 *
 * @return `true` if the [IntArray] is null or has no elements, `false` otherwise.
 * @since 6.1.0
 */
...
/**
 * Extension property for nullable IntArray that checks if the array is not null and not empty.
 *
 * @receiver Nullable IntArray to be checked.
 ...
 * @since 6.1.0
 */
val IntArray.containsDuplicates
 ...
 * @since 6.1.0
 */
val IntArray.isSingleElement get() = size == 1
/**
 ...
 * @since 6.1.0
 */
val IntArray.isNotSingleElement get() = size != 1

/**
 * Extension property that evaluates whether the IntArray is sorted in ascending order.
...
/**
 * Extension property for IntArray that indicates whether the array is not sorted in ascending order.
 *
 * This property returns `true` if the Int array is not sorted in ascending order, and `false` otherwise.
...
/**
 * An extension property for the `IntArray` class that checks if the array's elements are sorted
...
/**
 * Extension property for `IntArray` that determines whether
 * the array is not sorted in descending order.
 *
 * @return `true` if the Int array is not sorted in strictly descending order, `false` otherwise.
 * @since 6.1.0
 */
 ...
 *
 * This function provides a safe way to handle nullable IntArray instances by ensuring 
 * that a non-null IntArray is always returned.
 *
 * @return The original IntArray if it is non-null, otherwise an empty IntArray.
 * @since 6.1.0
 */
fun IntArray?.orEmpty() = this ?: intArrayOf()

/**
 * Performs a logical NOT operation on the nullable [IntArray].
 * This operator checks whether the [IntArray] is null or empty.
 *
 * @return `true` if the [IntArray] is null or empty, otherwise `false`.
 * @since 6.1.0
 */
@JvmName("nullableNot")
...
/**
 * Operator function that checks whether the IntArray is empty.
 *
 * @return true if the IntArray is empty, false otherwise.
 * @since 6.1.0
 */
...
fun IntArray?.merge(vararg collections: Collection<Int>) = orEmpty().toList().merge(*collections).toIntArray()
 ...
 * @since 6.1.0
 */
infix fun IntArray.intersects(other: IntArray) = (this intersect other.toSet()).isNotEmpty()
 ...
 * @since 6.1.0
 */
infix fun IntArray.intersperseWith(separator: Int): IntArray =
 ...
 * @since 6.1.0
 */
fun IntArray.containsAny(vararg elements: Int) = any { it in elements }
/**
 ...
 * @since 6.1.0
 */
fun IntArray.containsNone(vararg elements: Int) = none { it in elements }
/**
 ...
 * @since 6.1.0
 */
operator fun IntArray.contains(predicate: Predicate<Int>) = any { predicate(it) }
 ...
 * @since 6.1.0
 */
fun IntArray.firstOr(default: Supplier<Int>): Int {
    contract {
...
fun IntArray.firstOrThrow(lazyException: ThrowableSupplier): Int {
    contract {
 ...
 *         - `Right<Int>` contains the first element of the array.
 *         - `Left<Intmpty>` represents an error indicating that the array is empty.
 * @throws Throwable If any exception other than `NoSuchElementException` occurs during execution.
 * @since 6.1.0
 */
fun IntArray.firstOrError() = either {
 ...
 */
@IgnorableReturnValue
fun IntArray.findFirst(predicate: Predicate<Int>): Int {
    val list = toList()
 ...
 * @since 6.1.0
 */
fun IntArray.findFirstOr(default: Supplier<Int>, predicate: Predicate<Int>): Int {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun IntArray.findFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Int>): Int {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun IntArray.findFirstOrError(predicate: Predicate<Int>): Either<NotFirstResultErrors, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.lastOr(default: Supplier<Int>): Int {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun IntArray.lastOrThrow(lazyException: ThrowableSupplier): Int {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @receiver IntArray The array from which the last element is to be retrieved.
 * @return An `Either` where:
 *         - `Right<Int>` contains the last element of the array if it exists.
 *         - `Left<Intmpty>` represents an error raised when the array is empty.
 * @throws RaiseSignal If the underlying `either` or `catching` functions raise a signal during execution.
 * @see either
 * @see catching
 * @since 6.1.0
 */
fun IntArray.lastOrError() = either {
 ...
 */
@IgnorableReturnValue
fun IntArray.findLast(predicate: Predicate<Int>): Int {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun IntArray.findLastOr(default: Supplier<Int>, predicate: Predicate<Int>): Int {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun IntArray.findLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Int>): Int {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun IntArray.findLastOrError(predicate: Predicate<Int>): Either<NotLastResultsErrors, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.second() = if (size < 2) throw NoSuchElementException("List size $size doesn't allow to get second element.") else this[1]
/**
 ...
 * @since 6.1.0
 */
fun IntArray.secondOrNull() = if (size < 2) null else this[1]
/**
 ...
 * @since 6.1.0
 */
fun IntArray.secondOr(default: Supplier<Int>): Int {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun IntArray.secondOrThrow(lazyException: ThrowableSupplier): Int {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun IntArray.secondOrError(): Either<NotInnerElementErrors, Int> = either {
 ...
 */
@IgnorableReturnValue
fun IntArray.findSecond(predicate: Predicate<Int>): Int {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun IntArray.findSecondOrNull(predicate: Predicate<Int>) = filter(predicate).secondOrNull()
/**
 ...
 * @since 6.1.0
 */
fun IntArray.findSecondOr(default: Supplier<Int>, predicate: Predicate<Int>) = filter(predicate).secondOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun IntArray.findSecondOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Int>) = filter(predicate).secondOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun IntArray.findSecondOrError(predicate: Predicate<Int>): Either<NotInnerResultErrors, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.third() = if (size < 3) throw NoSuchElementException("List size $size doesn't allow to get third element.") else this[2]
/**
 ...
 * @since 6.1.0
 */
fun IntArray.thirdOrNull() = if (size < 3) null else this[2]
/**
 ...
 * @since 6.1.0
 */
fun IntArray.thirdOr(default: Supplier<Int>): Int {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun IntArray.thirdOrThrow(lazyException: ThrowableSupplier): Int {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun IntArray.thirdOrError(): Either<NotInnerElementErrors, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.findThird(predicate: Predicate<Int>): Int {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun IntArray.findThirdOrNull(predicate: Predicate<Int>) = filter(predicate).thirdOrNull()
/**
 ...
 * @since 6.1.0
 */
fun IntArray.findThirdOr(default: Supplier<Int>, predicate: Predicate<Int>) = filter(predicate).thirdOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun IntArray.findThirdOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Int>) = filter(predicate).thirdOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun IntArray.findThirdOrError(predicate: Predicate<Int>): Either<NotInnerResultErrors, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.onlyElement() = toList().run {
 ...
 * @since 6.1.0
 */
fun IntArray.onlyElementOrNull() = toList().run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.onlyElementOr(default: Supplier<Int>): Int {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
infix fun IntArray.onlyElementOrThrow(lazyException: ThrowableSupplier): Int {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @return `Either<NotOnlyElementErrors, Int>` where the right value is the single element of the array if present,
 ...
 * @since 6.1.0
 */
fun IntArray.onlyElementOrError(): Either<NotOnlyElementErrors, Int> = either {
 ...
 * @since 6.1.0
 */
infix fun IntArray.findOnlyElement(predicate: Predicate<Int>) = toList()
 ...
 * @since 6.1.0
 */
infix fun IntArray.findOnlyElementOrNull(predicate: Predicate<Int>) = filter(predicate).run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
fun IntArray.findOnlyElementOr(default: Supplier<Int>, predicate: Predicate<Int>): Int {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun IntArray.findOnlyElementOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Int>): Int {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun IntArray.findOnlyElementOrError(predicate: Predicate<Int>): Either<NotOnlyResultErrors, Int> = either {
 ...
 * @since 6.1.0
 */
infix fun IntArray.chunkedWhile(predicate: Predicate<Int>): List<List<Int>> = toList().run {
 ...
 * @since 6.1.0
 */
infix fun IntArray.repeatEach(n: Int): List<Int> {
 ...
 * @since 6.1.0
 */
fun IntArray.mode(): Int? = toTypedArray().groupingBy { it }.eachCount().maxByOrNull { it.value }?.key
 ...
 * @since 6.1.0
 */
fun IntArray.indexOfOrThrow(element: Int, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun IntArray.lastIndexOfOrThrow(element: Int, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun IntArray.indexOfFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Int>) =
 ...
 * @since 6.1.0
 */
fun IntArray.indexOfLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Int>) =
 ...
 * @since 6.1.0
 */
fun IntArray.indexOfOrError(element: Int) = either {
 ...
 * @since 6.1.0
 */
fun IntArray.lastIndexOfOrError(element: Int) = either {
 ...
 * @since 6.1.0
 */
fun IntArray.indexOfFirstOrError(predicate: Predicate<Int>) = either {
 ...
 *
 * @param predicate A lambda function that takes an element of type [Int] and returns `true`
 ...
 * @since 6.1.0
 */
fun IntArray.indexOfLastOrError(predicate: Predicate<Int>) = either {
 ...
 * @since 6.1.0
 */
inline fun IntArray?.ifNullOrEmpty(defaultValue: Supplier<IntArray>): IntArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun IntArray.ifNotEmpty(action: Consumer<IntArray>): IntArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun IntArray?.ifNotNullOrEmpty(action: Consumer<IntArray>): IntArray? {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
 ...
 */
@IgnorableReturnValue
inline fun IntArray.ifContains(element: Int, action: Consumer<IntArray>): IntArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
inline fun IntArray.ifNotContains(element: Int, action: Consumer<IntArray>): IntArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
    if (!contains(element)) action(this)
 ...
 * @since 6.1.0
 */
infix fun IntArray.step(step: Int) =  filterIndexed { index, c -> index % step == 0 }
 ...
 * @since 6.1.0
 */
operator fun IntArray.times(n: Int) = (1..n).flatMap { toList() }.toIntArray()
 ...
 * @since 6.1.0
 */
operator fun IntArray.div(predicate: Predicate<Int>) = partition(predicate)
 ...
 * @since 6.1.0
 */
operator fun IntArray.rem(chunkSize: Int): MultiList<Int> = toList().chunked(chunkSize)
/**
 ...
 * @since 6.1.0
 */
operator fun IntArray.rem(predicate: Predicate<Int>): MultiList<Int> = chunkedWhile(predicate)
 ...
 * @since 6.1.0
 */
operator fun IntArray.dec(): IntArray = toList().subList(0, lastIndex).toIntArray()
/**
 ...
 * @since 6.1.0
 */
operator fun IntArray.rangeTo(endIndex: Int) = toList().subList(0, endIndex + 1).toIntArray()
 ...
 * @since 6.1.0
 */
operator fun IntArray.invoke(circularStartIndex: Int, circularEndIndex: Int, step: Int = 1): IntArray {
 ...
 * @since 6.1.0
 */
operator fun IntArray.invoke(circularRange: IntRange, step: Int = 1) =
 ...
 * @since 6.1.0
 */
operator fun IntArray.invoke(circularProgression: IntProgression): IntArray {
 ...
 * @since 6.1.0
 */
operator fun IntArray.invoke(circularIndex: Int): Int {
    if (isEmpty()) throw IndexOutOfBoundsException("List cannot be null.")
 ...
 * @since 6.1.0
 */
inline operator fun IntArray.invoke(filter: Predicate<Int>): IntArray {
 ...
 * @since 6.1.0
 */
inline operator fun IntArray.get(find: Predicate<Int>): Int? {
 ...
 * @since 6.1.0
 */
operator fun IntArray.get(find: Predicate<Int>, lazyException: ThrowableSupplier): Int {
    for (element in this) if (find(element)) return element
    throw lazyException()
}
 ...
 * @since 6.1.0
 */
operator fun IntArray.minus(filterNot: Predicate<Int>) = filterNot(filterNot)
...
operator fun IntArray.get(range: IntProgression) = toList().subList(range).toIntArray()
 ...
 * @since 6.1.0
 */
operator fun IntArray.get(index: Int, lazyException: ThrowableSupplier = { IndexOutOfBoundsException("Index $index not present") }): Int =
 ...
 * @since 6.1.0
 */
operator fun IntArray.get(percentage: Percentage) = percent(percentage)
 ...
 * @since 6.1.0
 */
infix fun IntArray.sorted(direction: SortDirection) = when (direction) {
 ...
 * @since 6.1.0
 */
inline fun <R : Comparable<R>> IntArray.sortedBy(direction: SortDirection, crossinline selector: Transformer<Int, R?>) = when (direction) {
 ...
 * @since 6.1.0
 */
infix fun IntArray.before(element: Int) = if (contains(element)) get(0..<indexOf(element)) else intArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.beforeIncluding(element: Int) = if (contains(element)) get(0..indexOf(element)) else intArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.beforeLast(element: Int) = if (contains(element)) get(0..<lastIndexOf(element)) else intArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.beforeLastIncluding(element: Int) = if (contains(element)) get(0..lastIndexOf(element)) else intArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.after(element: Int) = if (contains(element)) get(indexOf(element) + 1..<size) else intArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.afterIncluding(element: Int) = if (contains(element)) get(indexOf(element)..size) else intArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.afterLast(element: Int) = if (contains(element)) get(lastIndexOf(element) + 1..<size) else intArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun IntArray.afterLastIncluding(element: Int) = if (contains(element)) get(lastIndexOf(element)..size) else intArrayOf()
...
infix fun IntArray.percent(p: Percentage): Int {
 ...
 * @since 6.1.0
 */
infix fun IntArray.percentOrError(p: Percentage): Either<IndexOutOfBoundsErrors, Int> = either {
 ...
 * @since 6.1.0
 */
inline fun <K, V> IntArray.associate(key: Transformer<Int, K>, value: Transformer<Int, V>) =
...
inline fun <K, V, M : MutableMap<in K, in V>> IntArray.associateTo(
    destination: M,
    key: Transformer<Int, K>,
    value: Transformer<Int, V>
 ...
 * 
 * @param element A transformer function that takes an element of type [Int] and returns a result of type [R].
 * @since 6.1.0
 */
inline infix fun <R> IntArray.filterNotNull(element: Transformer<Int, R>) =
 ...
 * @since 6.1.0
 */
inline infix fun <R> IntArray.filterNull(element: Transformer<Int, R>) =
    filter { element(it) == null }
 ...
 */
@IgnorableReturnValue
inline fun IntArray.cForEach(block: ReceiverBiConsumer<LoopContext, Int>) = apply {
    with(LoopContext()) {
 ...
 */
@IgnorableReturnValue
inline fun IntArray.cForEachIndexed(block: ReceiverTriConsumer<LoopContext, Int, Int>) = apply {
    with(LoopContext()) {
 ...
 * @param action a function that accepts a loop context and an element of type `Int`. 
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> IntArray.rForEach(action: ReceiverBiConsumer<LoopContext, Int>): R? {
    with(LoopContext()) {
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> IntArray.rForEachIndexed(action: ReceiverTriConsumer<LoopContext, Int, Int>): R? {
    with(LoopContext()) {
        for ([index, element] in withIndex()) {
            try {
