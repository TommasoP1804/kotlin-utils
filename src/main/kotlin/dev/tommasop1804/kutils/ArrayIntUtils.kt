 ...
 * @since 6.1.0
 */
fun IntArray.findFirstOrError(predicate: Predicate<Int>): Either<NotFirstResultError, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.findLastOrError(predicate: Predicate<Int>): Either<NotLastResultsError, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.secondOrError(): Either<NotInnerElementError, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.findSecondOrError(predicate: Predicate<Int>): Either<NotInnerResultError, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.thirdOrError(): Either<NotInnerElementError, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.findThirdOrError(predicate: Predicate<Int>): Either<NotInnerResultError, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.onlyElementOrError(): Either<NotOnlyElementError, Int> = either {
 ...
 * @since 6.1.0
 */
fun IntArray.findOnlyElementOrError(predicate: Predicate<Int>): Either<NotOnlyResultError, Int> = either {
 ...
 * @since 6.1.0
 */
infix fun IntArray.percentOrError(p: Percentage): Either<IndexOutOfBoundsError, Int> = either {
