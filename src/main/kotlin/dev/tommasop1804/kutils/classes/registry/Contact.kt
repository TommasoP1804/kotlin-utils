    ...
    value class PhoneNumber(val value: String) {
        ...
        val country: List<Country>
            get() = when (countryCode) {
                "1" -> listOf(Country.UnitedStates, Country.Canada)
                "1 (340)", "1(340)" -> listOf(Country.UsVirginIslands)
                "1 (670)", "1(670)" -> listOf(Country.NorthernMarianaIslands)
                "1 (671)", "1(671)" -> listOf(Country.Guam)
                "1 (684)", "1(684)" -> listOf(Country.AmericanSamoa)
                "1 (787)", "1(787)", "1 (939)", "1(939)" -> listOf(Country.PuertoRico)
                "1 (242)", "1(242)" -> listOf(Country.Bahamas)
                "1 (246)", "1(246)" -> listOf(Country.Barbados)
                "1 (264)", "1(264)" -> listOf(Country.Anguilla)
                "1 (268)", "1(268)" -> listOf(Country.AntiguaAndBarbuda)
                "1 (284)", "1(284)" -> listOf(Country.BritishVirginIslands)
                "1 (345)", "1(345)" -> listOf(Country.CaymanIslands)
                "1 (441)", "1(441)" -> listOf(Country.Bermuda)
                "1 (473)", "1(473)" -> listOf(Country.Grenada)
                "1 (649)", "1(649)" -> listOf(Country.TurksAndCaicosIslands)
                "1 (658)", "1(658)", "1 (876)", "1(876)" -> listOf(Country.Jamaica)
                "1 (664)", "1(664)" -> listOf(Country.Montserrat)
                "1 (721)", "1(721)" -> listOf(Country.SintMaarten)
                "1 (758)", "1(758)" -> listOf(Country.SaintLucia)
                "1 (767)", "1(767)" -> listOf(Country.Dominica)
                "1 (784)", "1(784)" -> listOf(Country.SaintVincentAndTheGrenadines)
                "1 (809)", "1(809)", "1 (829)", "1(829)", "1 (849)", "1(849)" -> listOf(Country.DominicanRepublic)
                "1 (868)", "1(868)" -> listOf(Country.TrinidadAndTobago)
                "1 (869)", "1(869)" -> listOf(Country.SaintKittsAndNevis)
                "20" -> listOf(Country.Egypt)
                "211" -> listOf(Country.SouthSudan)
                "212" -> listOf(Country.Morocco, Country.WesternSahara)
                ...
                "225" -> listOf(Country.CoteDIvorie)
                "226" -> listOf(Country.BurkinaFaso)
                ...
                "232" -> listOf(Country.SierraLeone)
                "233" -> listOf(Country.Ghana)
                "234" -> listOf(Country.Nigeria)
                "235" -> listOf(Country.Chad)
                "236" -> listOf(Country.CentralAfricanRepublic)
                "237" -> listOf(Country.Cameroon)
                "238" -> listOf(Country.CaboVerde)
                "239" -> listOf(Country.SaoTomeAndPrincipe)
                "240" -> listOf(Country.EquatorialGuinea)
                "241" -> listOf(Country.Gabon)
                "242" -> listOf(Country.Congo)
                "243" -> listOf(Country.DemocraticRepublicOfTheCongo)
                "244" -> listOf(Country.Angola)
                "245" -> listOf(Country.GuineaBissau)
                "246" -> listOf(Country.BritishIndianOceanTerritory)
                "247" -> listOf(Country.SaintHelenaAscensionAndTristanDaCunha)
                ...
                "27" -> listOf(Country.SouthAfrica)
                "290" -> listOf(Country.SaintHelenaAscensionAndTristanDaCunha)
                "291" -> listOf(Country.Eritrea)
                "297" -> listOf(Country.Aruba)
                "298" -> listOf(Country.FaroeIslands)
                ...
                "358 (18)", "358(18)" -> listOf(Country.AlandIsland)
                ...
                "378" -> listOf(Country.SanMarino)
                "379" -> listOf(Country.VaticanCity)
                ...
                "387" -> listOf(Country.BosniaAndHerzegovina)
                "389" -> listOf(Country.NorthMacedonia)
                "39" -> listOf(Country.Italy, Country.SanMarino, Country.VaticanCity)
                "40" -> listOf(Country.Romania)
                "41" -> listOf(Country.Switzerland)
                "420" -> listOf(Country.CzechRepublic)
                "421" -> listOf(Country.Slovakia)
                "423" -> listOf(Country.Liechtenstein)
                "43" -> listOf(Country.Austria)
                "44" -> listOf(Country.UnitedKingdom)
                "44 (1481)", "44(1481)" -> listOf(Country.Guernsey)
                "44 (1534)", "44(1534)" -> listOf(Country.Jersey)
                "44 (1624)", "44(1624)" -> listOf(Country.IsleOfMan)
                ...
                "500" -> listOf(Country.FalklandIslands, Country.SouthGeorgiaAndTheSouthSandwichIslands)
                "501" -> listOf(Country.Belize)
                "502" -> listOf(Country.Guatemala)
                "503" -> listOf(Country.ElSalvador)
                "504" -> listOf(Country.Honduras)
                "505" -> listOf(Country.Nicaragua)
                "506" -> listOf(Country.CostaRica)
                "507" -> listOf(Country.Panama)
                "508" -> listOf(Country.SaintPierreAndMiquelon)
                ...
                "590" -> listOf(Country.Guadeloupe, Country.SaintBarthelemy, Country.SaintMartin)
                "591" -> listOf(Country.Bolivia)
                "592" -> listOf(Country.Guyana)
                "593" -> listOf(Country.Ecuador)
                "594" -> listOf(Country.FrenchGuiana)
                "595" -> listOf(Country.Paraguay)
                "596" -> listOf(Country.Martinique)
                "597" -> listOf(Country.Suriname)
                "598" -> listOf(Country.Uruguay)
                "599" -> listOf(Country.BonaireSintEustatiusAndSaba, Country.Curacao)
                "60" -> listOf(Country.Malaysia)
                "61" -> listOf(Country.Australia)
                "61 (8 9162)", "61 (89162)" -> listOf(Country.CocosIslands)
                "61 (8 9164)", "61 (89164)" -> listOf(Country.ChristmasIsland)
                "62" -> listOf(Country.Indonesia)
                "63" -> listOf(Country.Philippines)
                "64" -> listOf(Country.NewZealand, Country.PitcairnIslands)
                "65" -> listOf(Country.Singapore)
                "66" -> listOf(Country.Thailand)
                "670" -> listOf(Country.TimorLeste)
                "672" -> listOf(Country.NorfolkIsland)
                "673" -> listOf(Country.Brunei)
                "674" -> listOf(Country.Nauru)
                "675" -> listOf(Country.PapuaNewGuinea)
                "676" -> listOf(Country.Tonga)
                "677" -> listOf(Country.SolomonIslands)
                "678" -> listOf(Country.Vanuatu)
                "679" -> listOf(Country.Fiji)
                "680" -> listOf(Country.Palau)
                "681" -> listOf(Country.WallisAndFutuna)
                "682" -> listOf(Country.CookIslands)
                "683" -> listOf(Country.Niue)
                "685" -> listOf(Country.Samoa)
                "686" -> listOf(Country.Kiribati)
                "687" -> listOf(Country.NewCaledonia)
                "688" -> listOf(Country.Tuvalu)
                "689" -> listOf(Country.FrenchPolynesia)
                "690" -> listOf(Country.Tokelau)
                "691" -> listOf(Country.Micronesia)
                "692" -> listOf(Country.MarshallIslands)
                "7" -> listOf(Country.RussianFederation, Country.Kazakhstan)
                "81" -> listOf(Country.Japan)
                "82" -> listOf(Country.SouthKorea)
                "84" -> listOf(Country.Vietnam)
                "850" -> listOf(Country.NorthKorea)
                "852" -> listOf(Country.HongKong)
