...
value class Ean13P5 private constructor(override val value: String) : CharSequence, ProductCode, ProductCode.Ean {
    ...
    init {
        println(value)
        validateInputFormat(value.isValidEan13P5())
    }
    ...
    companion object {
        ...
        fun CharSequence.toEan13P5() = filter { it.isDigit() || it in setOf(Char.SPACE, Char.HYPEN) }.run { either {
            catching({ Ean13P5(this@toEan13P5) }) { t: Throwable ->
                InvalidFormatOfType(this@toEan13P5, typeOf<Ean13P5>(), t)
            }
        } }
        ...
        class Deserializer : ValueDeserializer<Ean13P5>() {
            override fun deserialize(p: tools.jackson.core.JsonParser, ctxt: DeserializationContext) = Ean13P5(p.string)
        }

        class OldSerializer : JsonSerializer<Ean13P5>() {
            override fun serialize(value: Ean13P5, gen: JsonGenerator, serializers: SerializerProvider) =
                gen.writeString(value.value)
        }

        class OldDeserializer : JsonDeserializer<Ean13P5>() {
            override fun deserialize(p: JsonParser, ctxt: com.fasterxml.jackson.databind.DeserializationContext): Ean13P5 = Ean13P5(p.text)
        }

        @jakarta.persistence.Converter(autoApply = true)
        class Converter : AttributeConverter<Ean13P5?, String?> {
