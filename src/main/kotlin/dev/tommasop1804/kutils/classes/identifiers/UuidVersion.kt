...
enum class UuidVersion(val description: String, val number: Int) {
     ...
     * @since 3.0.0
     */
    V2("Version 2 is a variant of v1, specified by the Distributed Computing Environment (DCE). It is similar to v1 but replaces some of the timestamp with a user or domain identifier.", 2),
    /**
     ...
     * @since 3.0.0
     */
    V3("This version generate a UUID from a \"namespace\" (which is another UUID) and a \"name\" (a string). The resulting UUID is a hash of these two inputs. Hashing algoritm: MD5", 3),
    /**
     ...
     * @since 3.0.0
     */
    V4("This is the most common and widely used version. A UUID v4 is generated using purely random or pseudo-random numbers.", 4),
    /**
     ...
     * @since 3.0.0
     */
    V5("This version generate a UUID from a \"namespace\" (which is another UUID) and a \"name\" (a string). The resulting UUID is a hash of these two inputs. Hashing algoritm: SHA-1", 5),
    /**
     ...
     * @since 3.0.0
     */
    V8("This is a custom version of UUID", 8);
