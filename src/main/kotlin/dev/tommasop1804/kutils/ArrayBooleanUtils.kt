...
@file:JvmName("ArrayBooleanUtilsKt")
@file:Since("6.1.0")
...
/**
 * Extension property to check if the Boolean array is empty.
 *
 * @receiver The Boolean array being checked.
 * @return `true` if the Boolean array has no elements, otherwise `false`.
 * @since 6.1.0
 */
val BooleanArray.isEmpty get() = isEmpty()
/**
 * Extension property for `BooleanArray` that checks if the array is not empty.
 *
 * Returns `true` if the `BooleanArray` contains one or more elements.
 * Returns `false` if the `BooleanArray` is empty.
 * @since 6.1.0
 */
val BooleanArray.isNotEmpty get() = isNotEmpty()
/**
 * Extension property to check if a nullable [BooleanArray] is either null or empty.
 *
 * @return `true` if the [BooleanArray] is null or has no elements, `false` otherwise.
 * @since 6.1.0
 */
...
/**
 * Extension property for nullable BooleanArray that checks if the array is not null and not empty.
 *
 * @receiver Nullable BooleanArray to be checked.
 ...
 * @since 6.1.0
 */
val BooleanArray.containsDuplicates
 ...
 * @since 6.1.0
 */
val BooleanArray.isSingleElement get() = size == 1
/**
 ...
 * @since 6.1.0
 */
val BooleanArray.isNotSingleElement get() = size != 1

/**
 * Extension property that evaluates whether the BooleanArray is sorted in ascending order.
...
/**
 * Extension property for BooleanArray that indicates whether the array is not sorted in ascending order.
 *
 * This property returns `true` if the Boolean array is not sorted in ascending order, and `false` otherwise.
...
/**
 * An extension property for the `BooleanArray` class that checks if the array's elements are sorted
...
/**
 * Extension property for `BooleanArray` that determines whether
 * the array is not sorted in descending order.
 *
 * @return `true` if the Boolean array is not sorted in strictly descending order, `false` otherwise.
 * @since 6.1.0
 */
 ...
 * @since 6.1.0
 */
fun BooleanArray.orErrorIfEmpty(): Either<Empty, BooleanArray> =
    either { if (isEmpty()) raise(Empty) else this }

/**
 * Returns the current BooleanArray if it is not null, or an empty BooleanArray if it is null.
 *
 * This function provides a safe way to handle nullable BooleanArray instances by ensuring 
 * that a non-null BooleanArray is always returned.
 *
 * @return The original BooleanArray if it is non-null, otherwise an empty BooleanArray.
 * @since 6.1.0
 */
fun BooleanArray?.orEmpty() = this ?: booleanArrayOf()

/**
 * Performs a logical NOT operation on the nullable [BooleanArray].
 * This operator checks whether the [BooleanArray] is null or empty.
 *
 * @return `true` if the [BooleanArray] is null or empty, otherwise `false`.
 * @since 6.1.0
 */
@JvmName("nullableNot")
...
/**
 * Operator function that checks whether the BooleanArray is empty.
 *
 * @return true if the BooleanArray is empty, false otherwise.
 * @since 6.1.0
 */
...
fun BooleanArray?.merge(vararg collections: Collection<Boolean>) = orEmpty().toList().merge(*collections).toBooleanArray()
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.intersects(other: BooleanArray) = (this intersect other.toSet()).isNotEmpty()
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.intersperseWith(separator: Boolean): BooleanArray =
 ...
 * @since 6.1.0
 */
fun BooleanArray.containsAny(vararg elements: Boolean) = any { it in elements }
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.containsNone(vararg elements: Boolean) = none { it in elements }
/**
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.contains(predicate: Predicate<Boolean>) = any { predicate(it) }
 ...
 * @since 6.1.0
 */
fun BooleanArray.firstOr(default: Supplier<Boolean>): Boolean {
    contract {
...
fun BooleanArray.firstOrThrow(lazyException: ThrowableSupplier): Boolean {
    contract {
 ...
 *         - `Right<Boolean>` contains the first element of the array.
 *         - `Left<Booleanmpty>` represents an error indicating that the array is empty.
 * @throws Throwable If any exception other than `NoSuchElementException` occurs during execution.
 * @since 6.1.0
 */
fun BooleanArray.firstOrError() = either {
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findFirst(predicate: Predicate<Boolean>): Boolean {
    val list = toList()
 ...
 * @since 6.1.0
 */
fun BooleanArray.findFirstOr(default: Supplier<Boolean>, predicate: Predicate<Boolean>): Boolean {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Boolean>): Boolean {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun BooleanArray.findFirstOrError(predicate: Predicate<Boolean>): Either<NotFirstResultError, Boolean> = either {
 ...
 * @since 6.1.0
 */
fun BooleanArray.lastOr(default: Supplier<Boolean>): Boolean {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun BooleanArray.lastOrThrow(lazyException: ThrowableSupplier): Boolean {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @receiver BooleanArray The array from which the last element is to be retrieved.
 * @return An `Either` where:
 *         - `Right<Boolean>` contains the last element of the array if it exists.
 *         - `Left<Booleanmpty>` represents an error raised when the array is empty.
 * @throws RaiseSignal If the underlying `either` or `catching` functions raise a signal during execution.
 * @see either
 * @see catching
 * @since 6.1.0
 */
fun BooleanArray.lastOrError() = either {
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findLast(predicate: Predicate<Boolean>): Boolean {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun BooleanArray.findLastOr(default: Supplier<Boolean>, predicate: Predicate<Boolean>): Boolean {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Boolean>): Boolean {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun BooleanArray.findLastOrError(predicate: Predicate<Boolean>): Either<NotLastResultsError, Boolean> = either {
 ...
 * @since 6.1.0
 */
fun BooleanArray.second() = if (size < 2) throw NoSuchElementException("List size $size doesn't allow to get second element.") else this[1]
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.secondOrNull() = if (size < 2) null else this[1]
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.secondOr(default: Supplier<Boolean>): Boolean {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun BooleanArray.secondOrThrow(lazyException: ThrowableSupplier): Boolean {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun BooleanArray.secondOrError(): Either<NotInnerElementError, Boolean> = either {
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findSecond(predicate: Predicate<Boolean>): Boolean {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun BooleanArray.findSecondOrNull(predicate: Predicate<Boolean>) = filter(predicate).secondOrNull()
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.findSecondOr(default: Supplier<Boolean>, predicate: Predicate<Boolean>) = filter(predicate).secondOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findSecondOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Boolean>) = filter(predicate).secondOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.findSecondOrError(predicate: Predicate<Boolean>): Either<NotInnerResultError, Boolean> = either {
 ...
 * @since 6.1.0
 */
fun BooleanArray.third() = if (size < 3) throw NoSuchElementException("List size $size doesn't allow to get third element.") else this[2]
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.thirdOrNull() = if (size < 3) null else this[2]
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.thirdOr(default: Supplier<Boolean>): Boolean {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun BooleanArray.thirdOrThrow(lazyException: ThrowableSupplier): Boolean {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun BooleanArray.thirdOrError(): Either<NotInnerElementError, Boolean> = either {
 ...
 * @since 6.1.0
 */
fun BooleanArray.findThird(predicate: Predicate<Boolean>): Boolean {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun BooleanArray.findThirdOrNull(predicate: Predicate<Boolean>) = filter(predicate).thirdOrNull()
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.findThirdOr(default: Supplier<Boolean>, predicate: Predicate<Boolean>) = filter(predicate).thirdOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findThirdOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Boolean>) = filter(predicate).thirdOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.findThirdOrError(predicate: Predicate<Boolean>): Either<NotInnerResultError, Boolean> = either {
 ...
 * @since 6.1.0
 */
fun BooleanArray.onlyElement() = toList().run {
 ...
 * @since 6.1.0
 */
fun BooleanArray.onlyElementOrNull() = toList().run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.onlyElementOr(default: Supplier<Boolean>): Boolean {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
infix fun BooleanArray.onlyElementOrThrow(lazyException: ThrowableSupplier): Boolean {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @return `Either<NotOnlyElementErrors, Boolean>` where the right value is the single element of the array if present,
 ...
 * @since 6.1.0
 */
fun BooleanArray.onlyElementOrError(): Either<NotOnlyElementError, Boolean> = either {
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.findOnlyElement(predicate: Predicate<Boolean>) = toList()
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.findOnlyElementOrNull(predicate: Predicate<Boolean>) = filter(predicate).run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
fun BooleanArray.findOnlyElementOr(default: Supplier<Boolean>, predicate: Predicate<Boolean>): Boolean {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun BooleanArray.findOnlyElementOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Boolean>): Boolean {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun BooleanArray.findOnlyElementOrError(predicate: Predicate<Boolean>): Either<NotOnlyResultError, Boolean> = either {
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.chunkedWhile(predicate: Predicate<Boolean>): List<List<Boolean>> = toList().run {
    if (isEmpty()) return@run emptyList()
    val result = mutableListOf<MutableList<Boolean>>()
    var current = mutableListOf<Boolean>()
    for (i in indices) {
        current.add(this[i])
        if (predicate(this[i])) {
            result.add(current)
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.repeatEach(n: Int): List<Boolean> {
 ...
 * @since 6.1.0
 */
fun BooleanArray.mode(): Boolean? = toTypedArray().groupingBy { it }.eachCount().maxByOrNull { it.value }?.key
 ...
 * @since 6.1.0
 */
fun BooleanArray.indexOfOrThrow(element: Boolean, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun BooleanArray.lastIndexOfOrThrow(element: Boolean, lazyException: ThrowableSupplier) =
 ...
 * @since 6.1.0
 */
fun BooleanArray.indexOfFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Boolean>) =
 ...
 * @since 6.1.0
 */
fun BooleanArray.indexOfLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Boolean>) =
 ...
 * @since 6.1.0
 */
fun BooleanArray.indexOfOrError(element: Boolean) = either {
 ...
 * @since 6.1.0
 */
fun BooleanArray.lastIndexOfOrError(element: Boolean) = either {
 ...
 * @since 6.1.0
 */
fun BooleanArray.indexOfFirstOrError(predicate: Predicate<Boolean>) = either {
 ...
 *
 * @param predicate A lambda function that takes an element of type [Boolean] and returns `true`
 ...
 * @since 6.1.0
 */
fun BooleanArray.indexOfLastOrError(predicate: Predicate<Boolean>) = either {
 ...
 * @since 6.1.0
 */
inline fun BooleanArray?.ifNullOrEmpty(defaultValue: Supplier<BooleanArray>): BooleanArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun BooleanArray.ifNotEmpty(action: Consumer<BooleanArray>): BooleanArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun BooleanArray?.ifNotNullOrEmpty(action: Consumer<BooleanArray>): BooleanArray? {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
 ...
 */
@IgnorableReturnValue
inline fun BooleanArray.ifContains(element: Boolean, action: Consumer<BooleanArray>): BooleanArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
inline fun BooleanArray.ifNotContains(element: Boolean, action: Consumer<BooleanArray>): BooleanArray {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
    }
    if (!contains(element)) action(this)
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.step(step: Int) =  filterIndexed { index, c -> index % step == 0 }
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.times(n: Int) = (1..n).flatMap { toList() }.toBooleanArray()
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.div(predicate: Predicate<Boolean>) = partition(predicate)
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.rem(chunkSize: Int): MultiList<Boolean> = toList().chunked(chunkSize)
/**
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.rem(predicate: Predicate<Boolean>): MultiList<Boolean> = chunkedWhile(predicate)
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.dec(): BooleanArray = toList().subList(0, lastIndex).toBooleanArray()
/**
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.rangeTo(endIndex: Int) = toList().subList(0, endIndex + 1).toBooleanArray()
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.invoke(circularStartIndex: Int, circularEndIndex: Int, step: Int = 1): BooleanArray {
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.invoke(circularRange: IntRange, step: Int = 1) =
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.invoke(circularProgression: IntProgression): BooleanArray {
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.invoke(circularIndex: Int): Boolean {
    if (isEmpty()) throw IndexOutOfBoundsException("List cannot be null.")
 ...
 * @since 6.1.0
 */
inline operator fun BooleanArray.invoke(filter: Predicate<Boolean>): BooleanArray {
    val destination = ArrayList<Boolean>()
    for (element in this) if (filter(element)) destination.add(element)
    return destination.toBooleanArray()
}
 ...
 * @since 6.1.0
 */
inline operator fun BooleanArray.get(find: Predicate<Boolean>): Boolean? {
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.get(find: Predicate<Boolean>, lazyException: ThrowableSupplier): Boolean {
    for (element in this) if (find(element)) return element
    throw lazyException()
}
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.minus(filterNot: Predicate<Boolean>) = filterNot(filterNot)
...
operator fun BooleanArray.get(range: IntProgression) = toList().subList(range).toBooleanArray()
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.get(index: Int, lazyException: ThrowableSupplier = { IndexOutOfBoundsException("Index $index not present") }): Boolean =
 ...
 * @since 6.1.0
 */
operator fun BooleanArray.get(percentage: Percentage) = percent(percentage)
 ...
 * @since 6.1.0
 */
inline fun <R : Comparable<R>> BooleanArray.sortedBy(direction: SortDirection, crossinline selector: Transformer<Boolean, R?>) = when (direction) {
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.before(element: Boolean) = if (contains(element)) get(0..<indexOf(element)) else booleanArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.beforeIncluding(element: Boolean) = if (contains(element)) get(0..indexOf(element)) else booleanArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.beforeLast(element: Boolean) = if (contains(element)) get(0..<lastIndexOf(element)) else booleanArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.beforeLastIncluding(element: Boolean) = if (contains(element)) get(0..lastIndexOf(element)) else booleanArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.after(element: Boolean) = if (contains(element)) get(indexOf(element) + 1..<size) else booleanArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.afterIncluding(element: Boolean) = if (contains(element)) get(indexOf(element)..size) else booleanArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.afterLast(element: Boolean) = if (contains(element)) get(lastIndexOf(element) + 1..<size) else booleanArrayOf()
/**
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.afterLastIncluding(element: Boolean) = if (contains(element)) get(lastIndexOf(element)..size) else booleanArrayOf()
...
infix fun BooleanArray.percent(p: Percentage): Boolean {
 ...
 * @since 6.1.0
 */
infix fun BooleanArray.percentOrError(p: Percentage): Either<IndexOutOfBoundsError, Boolean> = either {
 ...
 * @since 6.1.0
 */
inline fun <K, V> BooleanArray.associate(key: Transformer<Boolean, K>, value: Transformer<Boolean, V>) =
...
inline fun <K, V, M : MutableMap<in K, in V>> BooleanArray.associateTo(
    destination: M,
    key: Transformer<Boolean, K>,
    value: Transformer<Boolean, V>
 ...
 * 
 * @param element A transformer function that takes an element of type [Boolean] and returns a result of type [R].
 * @since 6.1.0
 */
inline infix fun <R> BooleanArray.filterNotNull(element: Transformer<Boolean, R>) =
 ...
 * @since 6.1.0
 */
inline infix fun <R> BooleanArray.filterNull(element: Transformer<Boolean, R>) =
    filter { element(it) == null }
 ...
 */
@IgnorableReturnValue
inline fun BooleanArray.cForEach(block: ReceiverBiConsumer<LoopContext, Boolean>) = apply {
    with(LoopContext()) {
 ...
 */
@IgnorableReturnValue
inline fun BooleanArray.cForEachIndexed(block: ReceiverTriConsumer<LoopContext, Int, Boolean>) = apply {
    with(LoopContext()) {
 ...
 * @param action a function that accepts a loop context and an element of type `Boolean`. 
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> BooleanArray.rForEach(action: ReceiverBiConsumer<LoopContext, Boolean>): R? {
    with(LoopContext()) {
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> BooleanArray.rForEachIndexed(action: ReceiverTriConsumer<LoopContext, Int, Boolean>): R? {
    with(LoopContext()) {
        for ([index, element] in withIndex()) {
            try {
