...
/**
 * Extension property to check if the Float array is empty.
 *
 * @receiver The Float array being checked.
 * @return `true` if the Float array has no elements, otherwise `false`.
 * @since 6.1.0
 */
val FloatArray.isEmpty get() = isEmpty()
/**
 * Extension property for `FloatArray` that checks if the array is not empty.
 *
 * Returns `true` if the `FloatArray` contains one or more elements.
 * Returns `false` if the `FloatArray` is empty.
 * @since 6.1.0
 */
val FloatArray.isNotEmpty get() = isNotEmpty()
/**
 * Extension property to check if a nullable [FloatArray] is either null or empty.
 *
 * @return `true` if the [FloatArray] is null or has no elements, `false` otherwise.
 * @since 6.1.0
 */
...
/**
 * Extension property for nullable FloatArray that checks if the array is not null and not empty.
 *
 * @receiver Nullable FloatArray to be checked.
 ...
 * @since 6.1.0
 */
val FloatArray.containsDuplicates
 ...
 * @since 6.1.0
 */
val FloatArray.isSingleElement get() = size == 1
/**
 ...
 * @since 6.1.0
 */
val FloatArray.isNotSingleElement get() = size != 1

/**
 * Extension property that evaluates whether the FloatArray is sorted in ascending order.
...
/**
 * Extension property for FloatArray that indicates whether the array is not sorted in ascending order.
 *
 * This property returns `true` if the Float array is not sorted in ascending order, and `false` otherwise.
...
/**
 * An extension property for the `FloatArray` class that checks if the array's elements are sorted
...
/**
 * Extension property for `FloatArray` that determines whether
 * the array is not sorted in descending order.
 *
 * @return `true` if the Float array is not sorted in strictly descending order, `false` otherwise.
 * @since 6.1.0
 */
 ...
 * @since 6.1.0
 */
fun FloatArray.orErrorIfEmpty(): Either<Empty, FloatArray> =
    either { if (isEmpty()) raise(Empty) else this }

/**
 * Returns the current FloatArray if it is not null, or an empty FloatArray if it is null.
 *
 * This function provides a safe way to handle nullable FloatArray instances by ensuring 
 * that a non-null FloatArray is always returned.
 *
 * @return The original FloatArray if it is non-null, otherwise an empty FloatArray.
 * @since 6.1.0
 */
fun FloatArray?.orEmpty() = this ?: floatArrayOf()

/**
 * Performs a logical NOT operation on the nullable [FloatArray].
 * This operator checks whether the [FloatArray] is null or empty.
 *
 * @return `true` if the [FloatArray] is null or empty, otherwise `false`.
 * @since 6.1.0
 */
@JvmName("nullableNot")
...
/**
 * Operator function that checks whether the FloatArray is empty.
 *
...
fun FloatArray?.merge(vararg collections: Collection<Float>) = orEmpty().toList().merge(*collections).toFloatArray()
 ...
 * @since 6.1.0
 */
infix fun FloatArray.intersects(other: FloatArray) = (this intersect other.toSet()).isNotEmpty()
 ...
 * @since 6.1.0
 */
infix fun FloatArray.intersperseWith(separator: Float): FloatArray =
 ...
 * @since 6.1.0
 */
operator fun FloatArray.contains(predicate: Predicate<Float>) = any { predicate(it) }
 ...
 * @since 6.1.0
 */
fun FloatArray.firstOr(default: Supplier<Float>): Float {
    contract {
...
fun FloatArray.firstOrThrow(lazyException: ThrowableSupplier): Float {
    contract {
 ...
 *         - `Right<Float>` contains the first element of the array.
 *         - `Left<Floatmpty>` represents an error indicating that the array is empty.
 * @throws Throwable If any exception other than `NoSuchElementException` occurs during execution.
 * @since 6.1.0
 */
fun FloatArray.firstOrError() = either {
 ...
 */
@IgnorableReturnValue
fun FloatArray.findFirst(predicate: Predicate<Float>): Float {
    val list = toList()
 ...
 * @since 6.1.0
 */
fun FloatArray.findFirstOr(default: Supplier<Float>, predicate: Predicate<Float>): Float {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun FloatArray.findFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Float>): Float {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun FloatArray.lastOr(default: Supplier<Float>): Float {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun FloatArray.lastOrThrow(lazyException: ThrowableSupplier): Float {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @receiver FloatArray The array from which the last element is to be retrieved.
 * @return An `Either` where:
 *         - `Right<Float>` contains the last element of the array if it exists.
 *         - `Left<Floatmpty>` represents an error raised when the array is empty.
 * @throws RaiseSignal If the underlying `either` or `catching` functions raise a signal during execution.
 * @see either
 * @see catching
 * @since 6.1.0
 */
fun FloatArray.lastOrError() = either {
 ...
 */
@IgnorableReturnValue
fun FloatArray.findLast(predicate: Predicate<Float>): Float {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun FloatArray.findLastOr(default: Supplier<Float>, predicate: Predicate<Float>): Float {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun FloatArray.findLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Float>): Float {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun FloatArray.second() = if (size < 2) throw NoSuchElementException("List size $size doesn't allow to get second element.") else this[1]
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.secondOrNull() = if (size < 2) null else this[1]
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.secondOr(default: Supplier<Float>): Float {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun FloatArray.secondOrThrow(lazyException: ThrowableSupplier): Float {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun FloatArray.findSecond(predicate: Predicate<Float>): Float {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun FloatArray.findSecondOrNull(predicate: Predicate<Float>) = filter(predicate).secondOrNull()
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.findSecondOr(default: Supplier<Float>, predicate: Predicate<Float>) = filter(predicate).secondOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun FloatArray.findSecondOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Float>) = filter(predicate).secondOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.third() = if (size < 3) throw NoSuchElementException("List size $size doesn't allow to get third element.") else this[2]
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.thirdOrNull() = if (size < 3) null else this[2]
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.thirdOr(default: Supplier<Float>): Float {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun FloatArray.thirdOrThrow(lazyException: ThrowableSupplier): Float {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
fun FloatArray.findThird(predicate: Predicate<Float>): Float {
    val list = toList()
    if (list.isEmpty()) throw NoSuchElementException()
    val filtered = list.filter(predicate)
    if (filtered.isEmpty()) throw NoResultsException()
 ...
 * @since 6.1.0
 */
fun FloatArray.findThirdOrNull(predicate: Predicate<Float>) = filter(predicate).thirdOrNull()
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.findThirdOr(default: Supplier<Float>, predicate: Predicate<Float>) = filter(predicate).thirdOr(default)
/**
 ...
 */
@IgnorableReturnValue
fun FloatArray.findThirdOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Float>) = filter(predicate).thirdOrThrow(lazyException)
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.onlyElement() = toList().run {
 ...
 * @since 6.1.0
 */
fun FloatArray.onlyElementOrNull() = toList().run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
infix fun FloatArray.onlyElementOr(default: Supplier<Float>): Float {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
infix fun FloatArray.onlyElementOrThrow(lazyException: ThrowableSupplier): Float {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 *
 * @return `Either<NotOnlyElementErrors, Float>` where the right value is the single element of the array if present,
 ...
 * @since 6.1.0
 */
infix fun FloatArray.findOnlyElement(predicate: Predicate<Float>) = toList()
 ...
 * @since 6.1.0
 */
infix fun FloatArray.findOnlyElementOrNull(predicate: Predicate<Float>) = filter(predicate).run { if (size == 1) first() else null }
/**
 ...
 * @since 6.1.0
 */
fun FloatArray.findOnlyElementOr(default: Supplier<Float>, predicate: Predicate<Float>): Float {
    contract {
        callsInPlace(default, InvocationKind.AT_MOST_ONCE)
    }
 ...
 */
@IgnorableReturnValue
fun FloatArray.findOnlyElementOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Float>): Float {
    contract {
        callsInPlace(lazyException, InvocationKind.AT_MOST_ONCE)
    }
 ...
 * @since 6.1.0
 */
infix fun FloatArray.chunkedWhile(predicate: Predicate<Float>): List<List<Float>> = toList().run {
 ...
 * @since 6.1.0
 */
infix fun FloatArray.repeatEach(n: Int): List<Float> {
 ...
 * @since 6.1.0
 */
fun FloatArray.mode(): Float? = toTypedArray().groupingBy { it }.eachCount().maxByOrNull { it.value }?.key
 ...
 * @since 6.1.0
 */
fun FloatArray.indexOfFirstOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Float>) =
 ...
 * @since 6.1.0
 */
fun FloatArray.indexOfLastOrThrow(lazyException: ThrowableSupplier, predicate: Predicate<Float>) =
 ...
 * @since 6.1.0
 */
inline fun FloatArray?.ifNullOrEmpty(defaultValue: Supplier<FloatArray>): FloatArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun FloatArray.ifNotEmpty(action: Consumer<FloatArray>): FloatArray {
    contract {
 ...
 */
@IgnorableReturnValue
inline fun FloatArray?.ifNotNullOrEmpty(action: Consumer<FloatArray>): FloatArray? {
    contract {
        callsInPlace(action, InvocationKind.AT_MOST_ONCE)
 ...
 * @since 6.1.0
 */
infix fun FloatArray.step(step: Int) =  filterIndexed { index, c -> index % step == 0 }
 ...
 * @since 6.1.0
 */
operator fun FloatArray.times(n: Int) = (1..n).flatMap { toList() }.toFloatArray()
 ...
 * @since 6.1.0
 */
operator fun FloatArray.div(predicate: Predicate<Float>) = partition(predicate)
 ...
 * @since 6.1.0
 */
operator fun FloatArray.rem(chunkSize: Int): MultiList<Float> = toList().chunked(chunkSize)
/**
 ...
 * @since 6.1.0
 */
operator fun FloatArray.rem(predicate: Predicate<Float>): MultiList<Float> = chunkedWhile(predicate)
 ...
 * @since 6.1.0
 */
operator fun FloatArray.dec(): FloatArray = toList().subList(0, lastIndex).toFloatArray()
/**
 ...
 * @since 6.1.0
 */
operator fun FloatArray.rangeTo(endIndex: Int) = toList().subList(0, endIndex + 1).toFloatArray()
 ...
 * @since 6.1.0
 */
operator fun FloatArray.invoke(circularStartIndex: Int, circularEndIndex: Int, step: Int = 1): FloatArray {
 ...
 * @since 6.1.0
 */
operator fun FloatArray.invoke(circularRange: IntRange, step: Int = 1) =
 ...
 * @since 6.1.0
 */
operator fun FloatArray.invoke(circularProgression: IntProgression): FloatArray {
 ...
 * @since 6.1.0
 */
operator fun FloatArray.invoke(circularIndex: Int): Float {
    if (isEmpty()) throw IndexOutOfBoundsException("List cannot be null.")
 ...
 * @since 6.1.0
 */
inline operator fun FloatArray.invoke(filter: Predicate<Float>): FloatArray {
    val destination = ArrayList<Float>()
    for (element in this) if (filter(element)) destination.add(element)
    return destination.toFloatArray()
}
 ...
 * @since 6.1.0
 */
inline operator fun FloatArray.get(find: Predicate<Float>): Float? {
 ...
 * @since 6.1.0
 */
operator fun FloatArray.get(find: Predicate<Float>, lazyException: ThrowableSupplier): Float {
    for (element in this) if (find(element)) return element
    throw lazyException()
}
 ...
 * @since 6.1.0
 */
operator fun FloatArray.minus(filterNot: Predicate<Float>) = filterNot(filterNot)
...
operator fun FloatArray.get(range: IntProgression) = toList().subList(range).toFloatArray()
 ...
 * @since 6.1.0
 */
operator fun FloatArray.get(index: Int, lazyException: ThrowableSupplier = { IndexOutOfBoundsException("Index $index not present") }): Float =
 ...
 * @since 6.1.0
 */
operator fun FloatArray.get(percentage: Percentage) = percent(percentage)
 ...
 * @since 6.1.0
 */
infix fun FloatArray.sorted(direction: SortDirection) = when (direction) {
 ...
 * @since 6.1.0
 */
inline fun <R : Comparable<R>> FloatArray.sortedBy(direction: SortDirection, crossinline selector: Transformer<Float, R?>) = when (direction) {
...
infix fun FloatArray.percent(p: Percentage): Float {
 ...
 * @since 6.1.0
 */
inline fun <K, V> FloatArray.associate(key: Transformer<Float, K>, value: Transformer<Float, V>) =
...
inline fun <K, V, M : MutableMap<in K, in V>> FloatArray.associateTo(
    destination: M,
    key: Transformer<Float, K>,
    value: Transformer<Float, V>
 ...
 * 
 * @param element A transformer function that takes an element of type [Float] and returns a result of type [R].
 * @since 6.1.0
 */
inline infix fun <R> FloatArray.filterNotNull(element: Transformer<Float, R>) =
 ...
 * @since 6.1.0
 */
inline infix fun <R> FloatArray.filterNull(element: Transformer<Float, R>) =
    filter { element(it) == null }
 ...
 */
@IgnorableReturnValue
inline fun FloatArray.cForEach(block: ReceiverBiConsumer<LoopContext, Float>) = apply {
    with(LoopContext()) {
 ...
 */
@IgnorableReturnValue
inline fun FloatArray.cForEachIndexed(block: ReceiverTriConsumer<LoopContext, Int, Float>) = apply {
    with(LoopContext()) {
 ...
 * @param action a function that accepts a loop context and an element of type `Float`. 
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> FloatArray.rForEach(action: ReceiverBiConsumer<LoopContext, Float>): R? {
    with(LoopContext()) {
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <R> FloatArray.rForEachIndexed(action: ReceiverTriConsumer<LoopContext, Int, Float>): R? {
    with(LoopContext()) {
        for ([index, element] in withIndex()) {
            try {
